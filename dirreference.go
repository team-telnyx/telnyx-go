...
type Reference struct {
	...
	RecordType ReferenceRecordType `json:"record_type" api:"required"`
...
func (r Reference) RawJSON() string { return r.JSON.raw }
func (r *Reference) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// Always `dir_reference`.
type ReferenceRecordType string

const (
	ReferenceRecordTypeDirReference ReferenceRecordType = "dir_reference"
)

// Whether this is a business reference or the financial reference.
type ReferenceRefType string

const (
	ReferenceRefTypeBusiness  ReferenceRefType = "business"
	ReferenceRefTypeFinancial ReferenceRefType = "financial"
)
...
type ReferenceInputParam struct {
...
func (r ReferenceInputParam) MarshalJSON() (data []byte, err error) {
	type shadow ReferenceInputParam
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *ReferenceInputParam) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type ReferenceList struct {
	Data []Reference `json:"data" api:"required"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		Data        respjson.Field
		ExtraFields map[string]respjson.Field
...
// Returns the unmodified JSON received from the API
func (r ReferenceList) RawJSON() string { return r.JSON.raw }
...
type DirReferenceNewParams struct {
	...
	// One reference supplied at submit. The reference type is implied by the field
	// that carries it (business_references vs financial_reference).
	FinancialReference ReferenceInputParam `json:"financial_reference,omitzero" api:"required"`
	paramObj
}

func (r DirReferenceNewParams) MarshalJSON() (data []byte, err error) {
	type shadow DirReferenceNewParams
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *DirReferenceNewParams) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
