...
func TestCommentNewWithOptionalParams(t *testing.T) {
...
func TestCommentGet(t *testing.T) {
	...
	_, err := client.Comments.Get(context.TODO(), "id")
	if err != nil {
		var apierr *telnyx.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestCommentListWithOptionalParams(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Comments.List(context.TODO(), telnyx.CommentListParams{
		Filter: telnyx.CommentListParamsFilter{
			CommentRecordID:   telnyx.String("8ffb3622-7c6b-4ccc-b65f-7a3dc0099576"),
...
func TestCommentMarkAsRead(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Comments.MarkAsRead(context.TODO(), "id")
	if err != nil {
		var apierr *telnyx.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
