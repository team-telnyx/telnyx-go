...
func (r *EnterpriseReputationRemediationService) New(ctx context.Context, enterpriseID string, body EnterpriseReputationRemediationNewParams, opts ...option.RequestOption) (res *EnterpriseReputationRemediationNewResponse, err error) {
...
type EnterpriseReputationRemediationNewResponse struct {
	// Full detail of a remediation request, returned on submit and GET by id.
	Data EnterpriseReputationRemediationNewResponseData `json:"data" api:"required"`
...
func (r EnterpriseReputationRemediationNewResponse) RawJSON() string { return r.JSON.raw }
func (r *EnterpriseReputationRemediationNewResponse) UnmarshalJSON(data []byte) error {
...
// Returns the unmodified JSON received from the API
func (r EnterpriseReputationRemediationNewResponseData) RawJSON() string { return r.JSON.raw }
func (r *EnterpriseReputationRemediationNewResponseData) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// Per-category buckets. Populated once results are available. Null while the
// request is still pending.
type EnterpriseReputationRemediationNewResponseDataResults struct {
...
// Returns the unmodified JSON received from the API
func (r EnterpriseReputationRemediationNewResponseDataResults) RawJSON() string { return r.JSON.raw }
func (r *EnterpriseReputationRemediationNewResponseDataResults) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
func (r EnterpriseReputationRemediationNewParams) MarshalJSON() (data []byte, err error) {
	type shadow EnterpriseReputationRemediationNewParams
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *EnterpriseReputationRemediationNewParams) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
