...
func (r *EnterpriseReputationRemediationService) New(ctx context.Context, enterpriseID string, body EnterpriseReputationRemediationNewParams, opts ...option.RequestOption) (res *RemediationRequestWrapped, err error) {
...
func (r *EnterpriseReputationRemediationService) Get(ctx context.Context, remediationID string, query EnterpriseReputationRemediationGetParams, opts ...option.RequestOption) (res *RemediationRequestWrapped, err error) {
	opts = slices.Concat(r.Options, opts)
...
type RemediationRequestWrappedData struct {
	...
	Status       RemediationStatus `json:"status" api:"required"`
...
type EnterpriseReputationRemediationListParams struct {
	...
	//
	// Any of "pending", "in_progress", "completed", "failed", "cancelled".
	FilterStatus RemediationStatus `query:"filter[status],omitzero" json:"-"`
	paramObj
}
