...
type ConferenceRegion string

const (
	ConferenceRegionAustralia  ConferenceRegion = "Australia"
	ConferenceRegionEurope     ConferenceRegion = "Europe"
	ConferenceRegionMiddleEast ConferenceRegion = "Middle East"
	ConferenceRegionUs         ConferenceRegion = "US"
)
...
type UpdateConferenceParam struct {
	...
	Region ConferenceRegion `json:"region,omitzero"`
