...
type EnterpriseReputationNumberNewResponse struct {
	...
	Meta EnterpriseReputationNumberNewResponseMeta   `json:"meta"`
...
type EnterpriseReputationNumberNewResponseMeta struct {
	// Current page number
...
// Returns the unmodified JSON received from the API
func (r EnterpriseReputationNumberNewResponseMeta) RawJSON() string { return r.JSON.raw }
func (r *EnterpriseReputationNumberNewResponseMeta) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
