...
func TestTexmlAccountTranscriptionJsonDeleteRecordingTranscriptionSidJson(t *testing.T) {
...
func TestTexmlAccountTranscriptionJsonGetRecordingTranscriptionSidJson(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
