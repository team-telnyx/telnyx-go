...
// Returns the unmodified JSON received from the API
func (r ReputationData) RawJSON() string { return r.JSON.raw }
func (r *ReputationData) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
const (
	ReputationDataSpamRiskLow    ReputationDataSpamRisk = "low"
...
const (
	ResembleVoiceSettingsSampleRateSampleRate8000  ResembleVoiceSettingsSampleRate = "8000"
	ResembleVoiceSettingsSampleRateSampleRate16000 ResembleVoiceSettingsSampleRate = "16000"
	ResembleVoiceSettingsSampleRateSampleRate22050 ResembleVoiceSettingsSampleRate = "22050"
	ResembleVoiceSettingsSampleRateSampleRate32000 ResembleVoiceSettingsSampleRate = "32000"
	ResembleVoiceSettingsSampleRateSampleRate44100 ResembleVoiceSettingsSampleRate = "44100"
...
type WhatsappTemplateData struct {
	...
	UpdatedAt               time.Time                                   `json:"updated_at" format:"date-time"`
	WhatsappBusinessAccount WhatsappTemplateDataWhatsappBusinessAccount `json:"whatsapp_business_account"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		ID                      respjson.Field
...
// Returns the unmodified JSON received from the API
func (r WhatsappTemplateData) RawJSON() string { return r.JSON.raw }
func (r *WhatsappTemplateData) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type WhatsappTemplateDataCategory string

const (
	WhatsappTemplateDataCategoryMarketing      WhatsappTemplateDataCategory = "MARKETING"
	WhatsappTemplateDataCategoryUtility        WhatsappTemplateDataCategory = "UTILITY"
	WhatsappTemplateDataCategoryAuthentication WhatsappTemplateDataCategory = "AUTHENTICATION"
)

type WhatsappTemplateDataWhatsappBusinessAccount struct {
	ID string `json:"id"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		ID          respjson.Field
...
// Returns the unmodified JSON received from the API
func (r WhatsappTemplateDataWhatsappBusinessAccount) RawJSON() string { return r.JSON.raw }
