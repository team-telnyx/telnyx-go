...
type UacInboundRequestParam struct {
	// When set, this will limit the total number of inbound calls to phone numbers
	// associated with this connection.
	...
	//
	// Any of "+E.164", "E.164", "+E.164-national", "E.164-national".
	AniNumberFormat UacInboundRequestAniNumberFormat `json:"ani_number_format,omitzero"`
	// Defines the list of codecs that Telnyx will send for inbound calls to a specific
	// number on your portal account, in priority order. This only works when the
	// Connection the number is assigned to uses Media Handling mode: default. OPUS and
	// H.264 codecs are available only when using TCP or TLS transport for SIP.
	...
	//
	// Any of "sequential", "round-robin".
	DefaultRoutingMethod UacInboundRequestDefaultRoutingMethod `json:"default_routing_method,omitzero"`
	// Any of "+e164", "e164", "national", "sip_username".
	DnisNumberFormat UacInboundRequestDnisNumberFormat `json:"dnis_number_format,omitzero"`
	// When enabled, allows multiple devices to ring simultaneously on incoming calls.
	//
	// Any of "disabled", "enabled".
...
func (r UacInboundRequestParam) MarshalJSON() (data []byte, err error) {
	type shadow UacInboundRequestParam
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *UacInboundRequestParam) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// This setting allows you to set the format with which the caller's number (ANI)
// is sent for inbound phone calls.
type UacInboundRequestAniNumberFormat string

const (
	UacInboundRequestAniNumberFormatPlusE164         UacInboundRequestAniNumberFormat = "+E.164"
	UacInboundRequestAniNumberFormatE164             UacInboundRequestAniNumberFormat = "E.164"
	UacInboundRequestAniNumberFormatPlusE164National UacInboundRequestAniNumberFormat = "+E.164-national"
	UacInboundRequestAniNumberFormatE164National     UacInboundRequestAniNumberFormat = "E.164-national"
)

// Default routing method to be used when a number is associated with the
// connection. Must be one of the routing method types or left blank, other values
// are not allowed.
type UacInboundRequestDefaultRoutingMethod string

const (
	UacInboundRequestDefaultRoutingMethodSequential UacInboundRequestDefaultRoutingMethod = "sequential"
	UacInboundRequestDefaultRoutingMethodRoundRobin UacInboundRequestDefaultRoutingMethod = "round-robin"
)

type UacInboundRequestDnisNumberFormat string

const (
	UacInboundRequestDnisNumberFormatPlusE164    UacInboundRequestDnisNumberFormat = "+e164"
	UacInboundRequestDnisNumberFormatE164        UacInboundRequestDnisNumberFormat = "e164"
	UacInboundRequestDnisNumberFormatNational    UacInboundRequestDnisNumberFormat = "national"
	UacInboundRequestDnisNumberFormatSipUsername UacInboundRequestDnisNumberFormat = "sip_username"
)

// When enabled, allows multiple devices to ring simultaneously on incoming calls.
type UacInboundRequestSimultaneousRinging string
...
type UacConnectionNewParams struct {
	...
	// connection. The SIP subdomain fields returned in UAC connection responses are
	// generated by Telnyx and are not accepted as request parameters.
	Inbound UacInboundRequestParam `json:"inbound,omitzero"`
	// Internal Telnyx-side settings for a UAC connection.
