...
func (r *InexplicitNumberOrderService) List(ctx context.Context, query InexplicitNumberOrderListParams, opts ...option.RequestOption) (res *pagination.DefaultFlatPaginationForInexplicitNumberOrders[InexplicitNumberOrderResponse], err error) {
...
// Get a paginated list of inexplicit number orders.
func (r *InexplicitNumberOrderService) ListAutoPaging(ctx context.Context, query InexplicitNumberOrderListParams, opts ...option.RequestOption) *pagination.DefaultFlatPaginationForInexplicitNumberOrdersAutoPager[InexplicitNumberOrderResponse] {
	return pagination.NewDefaultFlatPaginationForInexplicitNumberOrdersAutoPager(r.List(ctx, query, opts...))
}

type InexplicitNumberOrderResponse struct {
	...
	OrderingGroups     []InexplicitNumberOrderResponseOrderingGroup `json:"ordering_groups"`
...
func (r InexplicitNumberOrderResponse) RawJSON() string { return r.JSON.raw }
func (r *InexplicitNumberOrderResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type InexplicitNumberOrderResponseOrderingGroup struct {
...
// Returns the unmodified JSON received from the API
func (r InexplicitNumberOrderResponseOrderingGroup) RawJSON() string { return r.JSON.raw }
func (r *InexplicitNumberOrderResponseOrderingGroup) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type InexplicitNumberOrderNewResponse struct {
	Data InexplicitNumberOrderResponse `json:"data"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		Data        respjson.Field
		ExtraFields map[string]respjson.Field
