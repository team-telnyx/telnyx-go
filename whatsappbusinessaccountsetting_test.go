...
func TestWhatsappBusinessAccountSettingGet(t *testing.T) {
	...
	_, err := client.Whatsapp.BusinessAccounts.Settings.Get(context.TODO(), "id")
	if err != nil {
...
func TestWhatsappBusinessAccountSettingUpdateWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
