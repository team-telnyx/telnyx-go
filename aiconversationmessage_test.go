...
func TestAIConversationMessageNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.AI.Conversations.Messages.New(
		context.TODO(),
		"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
		telnyx.AIConversationMessageNewParams{
			Role:    "role",
			Content: telnyx.String("content"),
			Metadata: map[string]telnyx.AIConversationMessageNewParamsMetadataUnion{
				"foo": {
