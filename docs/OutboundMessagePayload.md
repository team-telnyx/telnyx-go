...
**From** | Pointer to [**OutboundMessagePayloadFrom**](OutboundMessagePayloadFrom.md) |  | [optional] 
**To** | Pointer to [**[]OutboundMessagePayloadToInner**](OutboundMessagePayloadToInner.md) |  | [optional] 
...
**Media** | Pointer to [**[]OutboundMessagePayloadMediaInner**](OutboundMessagePayloadMediaInner.md) |  | [optional] 
...
**SentAt** | Pointer to **time.Time** | ISO 8601 formatted date indicating when the message was sent. | [optional] 
**CompletedAt** | Pointer to **time.Time** | ISO 8601 formatted date indicating when the message was finalized. | [optional] 
**ValidUntil** | Pointer to **NullableTime** | Message must be out of the queue by this time or else it will be discarded and marked as &#39;sending_failed&#39;. Once the message moves out of the queue, this field will be nulled | [optional] 
