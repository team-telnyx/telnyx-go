...
**CampaignId** | Pointer to **string** | Unique identifier for a campaign. | [optional] 
...
**Mock** | Pointer to **bool** | Campaign created from mock brand. Mocked campaign cannot be shared with an upstream CNP. | [optional] 
