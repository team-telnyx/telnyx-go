...
func TestNetworkGet(t *testing.T) {
	...
	_, err := client.Networks.Get(context.TODO(), "6a09cdc3-8948-47f0-aa62-74ac943d6c58")
	if err != nil {
		var apierr *telnyx.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestNetworkListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Networks.List(context.TODO(), telnyx.NetworkListParams{
...
func TestNetworkDelete(t *testing.T) {
	...
	_, err := client.Networks.Delete(context.TODO(), "6a09cdc3-8948-47f0-aa62-74ac943d6c58")
	if err != nil {
		var apierr *telnyx.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestNetworkListInterfacesWithOptionalParams(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Networks.ListInterfaces(
		...
		telnyx.NetworkListInterfacesParams{
			Filter: telnyx.NetworkListInterfacesParamsFilter{
