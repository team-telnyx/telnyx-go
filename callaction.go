...
func (r *CallActionService) StopConversationRelay(ctx context.Context, callControlID string, body CallActionStopConversationRelayParams, opts ...option.RequestOption) (res *CallActionStopConversationRelayResponse, err error) {
	opts = slices.Concat(r.Options, opts)
	if callControlID == "" {
		err = errors.New("missing required call_control_id parameter")
		return nil, err
...
//   - `openai/whisper-large-v3-turbo` for multilingual non-streaming transcription
//     with automatic language detection.
type TranscriptionConfigModel string

const (
	TranscriptionConfigModelDeepgramFlux                 TranscriptionConfigModel = "deepgram/flux"
	TranscriptionConfigModelFlux                         TranscriptionConfigModel = "flux"
	TranscriptionConfigModelDeepgramNova3                TranscriptionConfigModel = "deepgram/nova-3"
	...
	TranscriptionConfigModelDistilWhisperDistilLargeV2   TranscriptionConfigModel = "distil-whisper/distil-large-v2"
	TranscriptionConfigModelOpenAIWhisperLargeV3Turbo    TranscriptionConfigModel = "openai/whisper-large-v3-turbo"
)
...
// Returns a pointer to the underlying variant's property, if present.
func (u TranscriptionStartRequestTranscriptionEngineConfigUnionParam) GetEnableEndpointDetection() *bool {
	if vt := u.OfSoniox; vt != nil && vt.EnableEndpointDetection.Valid() {
		return &vt.EnableEndpointDetection.Value
	}
	return nil
}

// Returns a pointer to the underlying variant's property, if present.
func (u TranscriptionStartRequestTranscriptionEngineConfigUnionParam) GetMaxEndpointDelayMs() *int64 {
	if vt := u.OfSoniox; vt != nil && vt.MaxEndpointDelayMs.Valid() {
		return &vt.MaxEndpointDelayMs.Value
	}
	return nil
}
...
func (u TranscriptionStartRequestTranscriptionEngineConfigUnionParam) GetInterimResults() *bool {
	...
	} else if vt := u.OfXAI; vt != nil && vt.InterimResults.Valid() {
		return &vt.InterimResults.Value
...
type CallActionStartConversationRelayResponse struct {
	Data CallActionStartConversationRelayResponseData `json:"data"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		Data        respjson.Field
		ExtraFields map[string]respjson.Field
...
// Returns the unmodified JSON received from the API
func (r CallActionStartConversationRelayResponse) RawJSON() string { return r.JSON.raw }
func (r *CallActionStartConversationRelayResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type CallActionStartConversationRelayResponseData struct {
	// The ID of the Conversation Relay session created by the command.
	ConversationRelayID string `json:"conversation_relay_id"`
	Result              string `json:"result"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		ConversationRelayID respjson.Field
		Result              respjson.Field
		ExtraFields         map[string]respjson.Field
		raw                 string
	} `json:"-"`
...
// Returns the unmodified JSON received from the API
func (r CallActionStartConversationRelayResponseData) RawJSON() string { return r.JSON.raw }
func (r *CallActionStartConversationRelayResponseData) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type CallActionStopConversationRelayResponse struct {
	Data CallControlCommandResult `json:"data"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		Data        respjson.Field
...
// Returns the unmodified JSON received from the API
func (r CallActionStopConversationRelayResponse) RawJSON() string { return r.JSON.raw }
func (r *CallActionStopConversationRelayResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
func (u CallActionAddAIAssistantMessagesParamsMessageUnion) GetMetadata() map[string]any {
	if vt := u.OfUser; vt != nil {
		return vt.Metadata
	} else if vt := u.OfAssistant; vt != nil {
		return vt.Metadata
...
type CallActionAnswerParams struct {
	...
	ConversationRelayConfig CallActionAnswerParamsConversationRelayConfig `json:"conversation_relay_config,omitzero"`
...
type CallActionAnswerParamsConversationRelayConfig struct {
	...
	VoiceSettings CallActionAnswerParamsConversationRelayConfigVoiceSettingsUnion `json:"voice_settings,omitzero"`
	paramObj
}

func (r CallActionAnswerParamsConversationRelayConfig) MarshalJSON() (data []byte, err error) {
	type shadow CallActionAnswerParamsConversationRelayConfig
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *CallActionAnswerParamsConversationRelayConfig) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

func init() {
	apijson.RegisterFieldValidator[CallActionAnswerParamsConversationRelayConfig](
...
type CallActionAnswerParamsConversationRelayConfigLanguageVoiceSettingsUnion struct {
	...
	OfXai        *CallActionAnswerParamsConversationRelayConfigLanguageVoiceSettingsXai     `json:",omitzero,inline"`
	paramUnion
}
...
func init() {
	apijson.RegisterUnion[CallActionAnswerParamsConversationRelayConfigLanguageVoiceSettingsUnion](
		...
		apijson.Discriminator[CallActionAnswerParamsConversationRelayConfigLanguageVoiceSettingsXai]("xai"),
	)
}
...
// The property Type is required.
type CallActionAnswerParamsConversationRelayConfigLanguageVoiceSettingsXai struct {
...
func (r CallActionAnswerParamsConversationRelayConfigLanguageVoiceSettingsXai) MarshalJSON() (data []byte, err error) {
	type shadow CallActionAnswerParamsConversationRelayConfigLanguageVoiceSettingsXai
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *CallActionAnswerParamsConversationRelayConfigLanguageVoiceSettingsXai) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type CallActionAnswerParamsConversationRelayConfigVoiceSettingsUnion struct {
	...
	OfXai        *CallActionAnswerParamsConversationRelayConfigVoiceSettingsXai     `json:",omitzero,inline"`
	paramUnion
}

func (u CallActionAnswerParamsConversationRelayConfigVoiceSettingsUnion) MarshalJSON() ([]byte, error) {
	return param.MarshalUnion(u, u.OfElevenlabs,
		u.OfTelnyx,
		u.OfAws,
		u.OfMinimax,
...
func (u *CallActionAnswerParamsConversationRelayConfigVoiceSettingsUnion) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, u)
}

func (u *CallActionAnswerParamsConversationRelayConfigVoiceSettingsUnion) asAny() any {
	if !param.IsOmitted(u.OfElevenlabs) {
		return u.OfElevenlabs
	} else if !param.IsOmitted(u.OfTelnyx) {
		return u.OfTelnyx
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionAnswerParamsConversationRelayConfigVoiceSettingsUnion) GetLanguageBoost() *string {
	if vt := u.OfMinimax; vt != nil {
		return (*string)(&vt.LanguageBoost)
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionAnswerParamsConversationRelayConfigVoiceSettingsUnion) GetPitch() *int64 {
	if vt := u.OfMinimax; vt != nil && vt.Pitch.Valid() {
		return &vt.Pitch.Value
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionAnswerParamsConversationRelayConfigVoiceSettingsUnion) GetSpeed() *float64 {
	if vt := u.OfMinimax; vt != nil && vt.Speed.Valid() {
		return &vt.Speed.Value
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionAnswerParamsConversationRelayConfigVoiceSettingsUnion) GetVol() *float64 {
	if vt := u.OfMinimax; vt != nil && vt.Vol.Valid() {
		return &vt.Vol.Value
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionAnswerParamsConversationRelayConfigVoiceSettingsUnion) GetDeploymentID() *string {
	if vt := u.OfAzure; vt != nil && vt.DeploymentID.Valid() {
		return &vt.DeploymentID.Value
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionAnswerParamsConversationRelayConfigVoiceSettingsUnion) GetEffect() *string {
	if vt := u.OfAzure; vt != nil {
		return (*string)(&vt.Effect)
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionAnswerParamsConversationRelayConfigVoiceSettingsUnion) GetGender() *string {
	if vt := u.OfAzure; vt != nil {
		return (*string)(&vt.Gender)
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionAnswerParamsConversationRelayConfigVoiceSettingsUnion) GetRegion() *string {
	if vt := u.OfAzure; vt != nil && vt.Region.Valid() {
		return &vt.Region.Value
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionAnswerParamsConversationRelayConfigVoiceSettingsUnion) GetFormat() *string {
	if vt := u.OfResemble; vt != nil {
		return (*string)(&vt.Format)
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionAnswerParamsConversationRelayConfigVoiceSettingsUnion) GetPrecision() *string {
	if vt := u.OfResemble; vt != nil {
		return (*string)(&vt.Precision)
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionAnswerParamsConversationRelayConfigVoiceSettingsUnion) GetSampleRate() *string {
	if vt := u.OfResemble; vt != nil {
		return (*string)(&vt.SampleRate)
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionAnswerParamsConversationRelayConfigVoiceSettingsUnion) GetType() *string {
	if vt := u.OfElevenlabs; vt != nil {
		return (*string)(&vt.Type)
	} else if vt := u.OfTelnyx; vt != nil {
		return (*string)(&vt.Type)
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionAnswerParamsConversationRelayConfigVoiceSettingsUnion) GetAPIKeyRef() *string {
	if vt := u.OfElevenlabs; vt != nil && vt.APIKeyRef.Valid() {
		return &vt.APIKeyRef.Value
	} else if vt := u.OfAzure; vt != nil && vt.APIKeyRef.Valid() {
		return &vt.APIKeyRef.Value
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionAnswerParamsConversationRelayConfigVoiceSettingsUnion) GetVoiceSpeed() *float64 {
	if vt := u.OfTelnyx; vt != nil && vt.VoiceSpeed.Valid() {
		return &vt.VoiceSpeed.Value
	} else if vt := u.OfRime; vt != nil && vt.VoiceSpeed.Valid() {
		return &vt.VoiceSpeed.Value
...
func init() {
	apijson.RegisterUnion[CallActionAnswerParamsConversationRelayConfigVoiceSettingsUnion](
		"type",
		apijson.Discriminator[ElevenLabsVoiceSettingsParam]("elevenlabs"),
		apijson.Discriminator[TelnyxVoiceSettingsParam]("telnyx"),
		apijson.Discriminator[AwsVoiceSettingsParam]("aws"),
		...
		apijson.Discriminator[CallActionAnswerParamsConversationRelayConfigVoiceSettingsXai]("xai"),
	)
}
...
// The property Type is required.
type CallActionAnswerParamsConversationRelayConfigVoiceSettingsXai struct {
	// Language code, or `auto` to detect automatically.
	Language param.Opt[string] `json:"language,omitzero"`
	// Voice settings provider type
	//
...
func (r CallActionAnswerParamsConversationRelayConfigVoiceSettingsXai) MarshalJSON() (data []byte, err error) {
	type shadow CallActionAnswerParamsConversationRelayConfigVoiceSettingsXai
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *CallActionAnswerParamsConversationRelayConfigVoiceSettingsXai) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionGatherUsingSpeakParamsVoiceSettingsUnion) GetSpeed() *float64 {
	if vt := u.OfMinimax; vt != nil && vt.Speed.Valid() {
		return &vt.Speed.Value
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionGatherUsingSpeakParamsVoiceSettingsUnion) GetVol() *float64 {
	if vt := u.OfMinimax; vt != nil && vt.Vol.Valid() {
		return &vt.Vol.Value
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionSpeakParamsVoiceSettingsUnion) GetPitch() *int64 {
	if vt := u.OfMinimax; vt != nil && vt.Pitch.Valid() {
		return &vt.Pitch.Value
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionSpeakParamsVoiceSettingsUnion) GetSpeed() *float64 {
	if vt := u.OfMinimax; vt != nil && vt.Speed.Valid() {
		return &vt.Speed.Value
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionSpeakParamsVoiceSettingsUnion) GetVol() *float64 {
	if vt := u.OfMinimax; vt != nil && vt.Vol.Valid() {
		return &vt.Vol.Value
	}
	return nil
...
type CallActionStartAIAssistantParams struct {
	...
	MessageHistory []CallActionStartAIAssistantParamsMessageHistoryUnion `json:"message_history,omitzero"`
	// A list of participants to add to the conversation when it starts.
	Participants []CallActionStartAIAssistantParamsParticipant `json:"participants,omitzero"`
	// The settings associated with speech to text for the voice assistant. This is
	// only relevant if the assistant uses a text-to-text language model. Any assistant
	// using a model with native audio support (e.g. `fixie-ai/ultravox-v0_4`) will
	// ignore this field.
...
//
// Use [param.IsOmitted] to confirm if a field is set.
type CallActionStartAIAssistantParamsMessageHistoryUnion struct {
	OfUser      *CallActionStartAIAssistantParamsMessageHistoryUser      `json:",omitzero,inline"`
	OfAssistant *CallActionStartAIAssistantParamsMessageHistoryAssistant `json:",omitzero,inline"`
	OfTool      *CallActionStartAIAssistantParamsMessageHistoryTool      `json:",omitzero,inline"`
	OfSystem    *CallActionStartAIAssistantParamsMessageHistorySystem    `json:",omitzero,inline"`
	OfDeveloper *CallActionStartAIAssistantParamsMessageHistoryDeveloper `json:",omitzero,inline"`
	paramUnion
}

func (u CallActionStartAIAssistantParamsMessageHistoryUnion) MarshalJSON() ([]byte, error) {
	return param.MarshalUnion(u, u.OfUser,
		u.OfAssistant,
		u.OfTool,
		u.OfSystem,
...
func (u *CallActionStartAIAssistantParamsMessageHistoryUnion) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, u)
}

func (u *CallActionStartAIAssistantParamsMessageHistoryUnion) asAny() any {
	if !param.IsOmitted(u.OfUser) {
		return u.OfUser
	} else if !param.IsOmitted(u.OfAssistant) {
		return u.OfAssistant
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionStartAIAssistantParamsMessageHistoryUnion) GetToolCalls() []CallActionStartAIAssistantParamsMessageHistoryAssistantToolCall {
	if vt := u.OfAssistant; vt != nil {
		return vt.ToolCalls
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionStartAIAssistantParamsMessageHistoryUnion) GetToolCallID() *string {
	if vt := u.OfTool; vt != nil {
		return &vt.ToolCallID
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionStartAIAssistantParamsMessageHistoryUnion) GetContent() *string {
	if vt := u.OfUser; vt != nil {
		return (*string)(&vt.Content)
	} else if vt := u.OfAssistant; vt != nil && vt.Content.Valid() {
		return &vt.Content.Value
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionStartAIAssistantParamsMessageHistoryUnion) GetRole() *string {
	if vt := u.OfUser; vt != nil {
		return (*string)(&vt.Role)
	} else if vt := u.OfAssistant; vt != nil {
		return (*string)(&vt.Role)
...
// Returns a pointer to the underlying variant's Metadata property, if present.
func (u CallActionStartAIAssistantParamsMessageHistoryUnion) GetMetadata() map[string]any {
	if vt := u.OfUser; vt != nil {
		return vt.Metadata
	} else if vt := u.OfAssistant; vt != nil {
		return vt.Metadata
...
func init() {
	apijson.RegisterUnion[CallActionStartAIAssistantParamsMessageHistoryUnion](
		"role",
		apijson.Discriminator[CallActionStartAIAssistantParamsMessageHistoryUser]("user"),
		apijson.Discriminator[CallActionStartAIAssistantParamsMessageHistoryAssistant]("assistant"),
		apijson.Discriminator[CallActionStartAIAssistantParamsMessageHistoryTool]("tool"),
		apijson.Discriminator[CallActionStartAIAssistantParamsMessageHistorySystem]("system"),
		apijson.Discriminator[CallActionStartAIAssistantParamsMessageHistoryDeveloper]("developer"),
	)
}
...
//
// The properties Content, Role are required.
type CallActionStartAIAssistantParamsMessageHistoryUser struct {
	// The contents of the user message.
	Content string `json:"content" api:"required"`
	// Metadata to add to the message
	Metadata map[string]any `json:"metadata,omitzero"`
...
func (r CallActionStartAIAssistantParamsMessageHistoryUser) MarshalJSON() (data []byte, err error) {
	type shadow CallActionStartAIAssistantParamsMessageHistoryUser
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *CallActionStartAIAssistantParamsMessageHistoryUser) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
//
// The property Role is required.
type CallActionStartAIAssistantParamsMessageHistoryAssistant struct {
	// The contents of the assistant message. Required unless `tool_calls`
	Content param.Opt[string] `json:"content,omitzero"`
	// Metadata to add to the message
	Metadata map[string]any `json:"metadata,omitzero"`
	// The tool calls generated by the model, such as function calls.
	ToolCalls []CallActionStartAIAssistantParamsMessageHistoryAssistantToolCall `json:"tool_calls,omitzero"`
	// The role of the messages author, in this case `assistant`.
	//
	// This field can be elided, and will marshal its zero value as "assistant".
	Role constant.Assistant `json:"role" default:"assistant"`
...
func (r CallActionStartAIAssistantParamsMessageHistoryAssistant) MarshalJSON() (data []byte, err error) {
	type shadow CallActionStartAIAssistantParamsMessageHistoryAssistant
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *CallActionStartAIAssistantParamsMessageHistoryAssistant) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
//
// The properties ID, Function, Type are required.
type CallActionStartAIAssistantParamsMessageHistoryAssistantToolCall struct {
	// The ID of the tool call.
	ID string `json:"id" api:"required"`
	// The function that the model called.
	Function CallActionStartAIAssistantParamsMessageHistoryAssistantToolCallFunction `json:"function,omitzero" api:"required"`
	// The type of the tool. Currently, only `function` is supported.
	//
	// Any of "function".
	Type string `json:"type,omitzero" api:"required"`
...
func (r CallActionStartAIAssistantParamsMessageHistoryAssistantToolCall) MarshalJSON() (data []byte, err error) {
	type shadow CallActionStartAIAssistantParamsMessageHistoryAssistantToolCall
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *CallActionStartAIAssistantParamsMessageHistoryAssistantToolCall) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

func init() {
	apijson.RegisterFieldValidator[CallActionStartAIAssistantParamsMessageHistoryAssistantToolCall](
		"type", "function",
	)
}
...
//
// The property Name is required.
type CallActionStartAIAssistantParamsMessageHistoryAssistantToolCallFunction struct {
	// The name of the function to call.
	Name string `json:"name" api:"required"`
	paramObj
}

func (r CallActionStartAIAssistantParamsMessageHistoryAssistantToolCallFunction) MarshalJSON() (data []byte, err error) {
	type shadow CallActionStartAIAssistantParamsMessageHistoryAssistantToolCallFunction
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *CallActionStartAIAssistantParamsMessageHistoryAssistantToolCallFunction) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// The properties Content, Role, ToolCallID are required.
type CallActionStartAIAssistantParamsMessageHistoryTool struct {
	// The contents of the tool message.
	Content string `json:"content" api:"required"`
	// Tool call that this message is responding to.
	ToolCallID string `json:"tool_call_id" api:"required"`
...
func (r CallActionStartAIAssistantParamsMessageHistoryTool) MarshalJSON() (data []byte, err error) {
	type shadow CallActionStartAIAssistantParamsMessageHistoryTool
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *CallActionStartAIAssistantParamsMessageHistoryTool) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
//
// The properties Content, Role are required.
type CallActionStartAIAssistantParamsMessageHistorySystem struct {
	// The contents of the system message.
	Content string `json:"content" api:"required"`
	// Metadata to add to the message
	Metadata map[string]any `json:"metadata,omitzero"`
...
func (r CallActionStartAIAssistantParamsMessageHistorySystem) MarshalJSON() (data []byte, err error) {
	type shadow CallActionStartAIAssistantParamsMessageHistorySystem
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *CallActionStartAIAssistantParamsMessageHistorySystem) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
//
// The properties Content, Role are required.
type CallActionStartAIAssistantParamsMessageHistoryDeveloper struct {
	// The contents of the developer message.
	Content string `json:"content" api:"required"`
	// Metadata to add to the message
	Metadata map[string]any `json:"metadata,omitzero"`
...
func (r CallActionStartAIAssistantParamsMessageHistoryDeveloper) MarshalJSON() (data []byte, err error) {
	type shadow CallActionStartAIAssistantParamsMessageHistoryDeveloper
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *CallActionStartAIAssistantParamsMessageHistoryDeveloper) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// The properties ID, Role are required.
type CallActionStartAIAssistantParamsParticipant struct {
	// The call_control_id of the participant to add to the conversation.
	ID string `json:"id" api:"required"`
	// The role of the participant in the conversation.
	//
...
func (r CallActionStartAIAssistantParamsParticipant) MarshalJSON() (data []byte, err error) {
	type shadow CallActionStartAIAssistantParamsParticipant
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *CallActionStartAIAssistantParamsParticipant) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

func init() {
	apijson.RegisterFieldValidator[CallActionStartAIAssistantParamsParticipant](
		"role", "user",
	)
	apijson.RegisterFieldValidator[CallActionStartAIAssistantParamsParticipant](
		"on_hangup", "continue_conversation", "end_conversation",
...
type CallActionStartConversationRelayParams struct {
	...
	//
	// Any of "none", "any", "speech", "dtmf".
	Interruptible CallActionStartConversationRelayParamsInterruptible `json:"interruptible,omitzero"`
	// Controls when caller input can interrupt assistant speech. `any` allows speech
	// or DTMF interruptions; `none` disables interruptions; `speech` allows speech
	// only; `dtmf` allows DTMF only.
	//
	...
	Transcription map[string]any `json:"transcription,omitzero"`
	// Engine to use for speech recognition. Legacy values `A` - `Google`, `B` -
	// `Telnyx` are supported for backward compatibility. For Conversation Relay, use
	// this field with `transcription_engine_config`; the `transcription` object is not
	// supported.
	...
	// Any of "Google", "Telnyx", "Deepgram", "Azure", "xAI", "AssemblyAI",
	// "Speechmatics", "Soniox", "A", "B".
	TranscriptionEngine CallActionStartConversationRelayParamsTranscriptionEngine `json:"transcription_engine,omitzero"`
	// Engine-specific transcription settings for Conversation Relay. This accepts the
	// same provider-specific options used by the Call Transcription Start command,
	// such as `transcription_model`, without requiring the engine discriminator to be
	// repeated inside this object.
	TranscriptionEngineConfig map[string]any `json:"transcription_engine_config,omitzero"`
	// The settings associated with the voice selected
	VoiceSettings CallActionStartConversationRelayParamsVoiceSettingsUnion `json:"voice_settings,omitzero"`
	paramObj
}

func (r CallActionStartConversationRelayParams) MarshalJSON() (data []byte, err error) {
	type shadow CallActionStartConversationRelayParams
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *CallActionStartConversationRelayParams) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// Custom parameters for the Conversation Relay session. Pass key-value data as
// `assistant.dynamic_variables` to make it available to the relay session.
type CallActionStartConversationRelayParamsAssistant struct {
...
func (r CallActionStartConversationRelayParamsAssistant) MarshalJSON() (data []byte, err error) {
	type shadow CallActionStartConversationRelayParamsAssistant
	return param.MarshalWithExtras(r, (*shadow)(&r), r.ExtraFields)
}
...
type CallActionStartConversationRelayParamsConversationRelaySettingsLanguageVoiceSettingsUnion struct {
	...
	OfXai        *CallActionStartConversationRelayParamsConversationRelaySettingsLanguageVoiceSettingsXai     `json:",omitzero,inline"`
	paramUnion
}
...
func init() {
	apijson.RegisterUnion[CallActionStartConversationRelayParamsConversationRelaySettingsLanguageVoiceSettingsUnion](
		...
		apijson.Discriminator[CallActionStartConversationRelayParamsConversationRelaySettingsLanguageVoiceSettingsXai]("xai"),
	)
}
...
// The property Type is required.
type CallActionStartConversationRelayParamsConversationRelaySettingsLanguageVoiceSettingsXai struct {
	// Language code, or `auto` to detect automatically.
	Language param.Opt[string] `json:"language,omitzero"`
	// Voice settings provider type
	//
...
func (r CallActionStartConversationRelayParamsConversationRelaySettingsLanguageVoiceSettingsXai) MarshalJSON() (data []byte, err error) {
	type shadow CallActionStartConversationRelayParamsConversationRelaySettingsLanguageVoiceSettingsXai
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *CallActionStartConversationRelayParamsConversationRelaySettingsLanguageVoiceSettingsXai) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
// or DTMF interruptions; `none` disables interruptions; `speech` allows speech
// only; `dtmf` allows DTMF only.
type CallActionStartConversationRelayParamsInterruptible string

const (
	CallActionStartConversationRelayParamsInterruptibleNone   CallActionStartConversationRelayParamsInterruptible = "none"
	CallActionStartConversationRelayParamsInterruptibleAny    CallActionStartConversationRelayParamsInterruptible = "any"
	CallActionStartConversationRelayParamsInterruptibleSpeech CallActionStartConversationRelayParamsInterruptible = "speech"
	CallActionStartConversationRelayParamsInterruptibleDtmf   CallActionStartConversationRelayParamsInterruptible = "dtmf"
)

// Controls when caller input can interrupt assistant speech. `any` allows speech
// or DTMF interruptions; `none` disables interruptions; `speech` allows speech
// only; `dtmf` allows DTMF only.
type CallActionStartConversationRelayParamsInterruptibleGreeting string

const (
	CallActionStartConversationRelayParamsInterruptibleGreetingNone   CallActionStartConversationRelayParamsInterruptibleGreeting = "none"
	CallActionStartConversationRelayParamsInterruptibleGreetingAny    CallActionStartConversationRelayParamsInterruptibleGreeting = "any"
	CallActionStartConversationRelayParamsInterruptibleGreetingSpeech CallActionStartConversationRelayParamsInterruptibleGreeting = "speech"
...
type CallActionStartConversationRelayParamsLanguageVoiceSettingsUnion struct {
	...
	OfXai        *CallActionStartConversationRelayParamsLanguageVoiceSettingsXai     `json:",omitzero,inline"`
	paramUnion
}
...
func init() {
	apijson.RegisterUnion[CallActionStartConversationRelayParamsLanguageVoiceSettingsUnion](
		...
		apijson.Discriminator[CallActionStartConversationRelayParamsLanguageVoiceSettingsXai]("xai"),
	)
}
...
// The property Type is required.
type CallActionStartConversationRelayParamsLanguageVoiceSettingsXai struct {
	// Language code, or `auto` to detect automatically.
	Language param.Opt[string] `json:"language,omitzero"`
	// Voice settings provider type
	//
...
func (r CallActionStartConversationRelayParamsLanguageVoiceSettingsXai) MarshalJSON() (data []byte, err error) {
	type shadow CallActionStartConversationRelayParamsLanguageVoiceSettingsXai
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *CallActionStartConversationRelayParamsLanguageVoiceSettingsXai) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
// this field with `transcription_engine_config`; the `transcription` object is not
// supported.
type CallActionStartConversationRelayParamsTranscriptionEngine string

const (
	CallActionStartConversationRelayParamsTranscriptionEngineGoogle       CallActionStartConversationRelayParamsTranscriptionEngine = "Google"
	CallActionStartConversationRelayParamsTranscriptionEngineTelnyx       CallActionStartConversationRelayParamsTranscriptionEngine = "Telnyx"
	CallActionStartConversationRelayParamsTranscriptionEngineDeepgram     CallActionStartConversationRelayParamsTranscriptionEngine = "Deepgram"
	CallActionStartConversationRelayParamsTranscriptionEngineAzure        CallActionStartConversationRelayParamsTranscriptionEngine = "Azure"
	CallActionStartConversationRelayParamsTranscriptionEngineXAI          CallActionStartConversationRelayParamsTranscriptionEngine = "xAI"
	CallActionStartConversationRelayParamsTranscriptionEngineAssemblyAI   CallActionStartConversationRelayParamsTranscriptionEngine = "AssemblyAI"
	CallActionStartConversationRelayParamsTranscriptionEngineSpeechmatics CallActionStartConversationRelayParamsTranscriptionEngine = "Speechmatics"
	CallActionStartConversationRelayParamsTranscriptionEngineSoniox       CallActionStartConversationRelayParamsTranscriptionEngine = "Soniox"
	CallActionStartConversationRelayParamsTranscriptionEngineA            CallActionStartConversationRelayParamsTranscriptionEngine = "A"
	CallActionStartConversationRelayParamsTranscriptionEngineB            CallActionStartConversationRelayParamsTranscriptionEngine = "B"
)
...
func (u CallActionStartConversationRelayParamsVoiceSettingsUnion) MarshalJSON() ([]byte, error) {
	return param.MarshalUnion(u, u.OfElevenlabs,
		u.OfTelnyx,
		u.OfAws,
		u.OfMinimax,
...
func (u *CallActionStartConversationRelayParamsVoiceSettingsUnion) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, u)
}

func (u *CallActionStartConversationRelayParamsVoiceSettingsUnion) asAny() any {
	if !param.IsOmitted(u.OfElevenlabs) {
		return u.OfElevenlabs
	} else if !param.IsOmitted(u.OfTelnyx) {
		return u.OfTelnyx
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionStartConversationRelayParamsVoiceSettingsUnion) GetLanguageBoost() *string {
	if vt := u.OfMinimax; vt != nil {
		return (*string)(&vt.LanguageBoost)
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionStartConversationRelayParamsVoiceSettingsUnion) GetPitch() *int64 {
	if vt := u.OfMinimax; vt != nil && vt.Pitch.Valid() {
		return &vt.Pitch.Value
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionStartConversationRelayParamsVoiceSettingsUnion) GetSpeed() *float64 {
	if vt := u.OfMinimax; vt != nil && vt.Speed.Valid() {
		return &vt.Speed.Value
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionStartConversationRelayParamsVoiceSettingsUnion) GetVol() *float64 {
	if vt := u.OfMinimax; vt != nil && vt.Vol.Valid() {
		return &vt.Vol.Value
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionStartConversationRelayParamsVoiceSettingsUnion) GetDeploymentID() *string {
	if vt := u.OfAzure; vt != nil && vt.DeploymentID.Valid() {
		return &vt.DeploymentID.Value
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionStartConversationRelayParamsVoiceSettingsUnion) GetEffect() *string {
	if vt := u.OfAzure; vt != nil {
		return (*string)(&vt.Effect)
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionStartConversationRelayParamsVoiceSettingsUnion) GetGender() *string {
	if vt := u.OfAzure; vt != nil {
		return (*string)(&vt.Gender)
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionStartConversationRelayParamsVoiceSettingsUnion) GetRegion() *string {
	if vt := u.OfAzure; vt != nil && vt.Region.Valid() {
		return &vt.Region.Value
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionStartConversationRelayParamsVoiceSettingsUnion) GetFormat() *string {
	if vt := u.OfResemble; vt != nil {
		return (*string)(&vt.Format)
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionStartConversationRelayParamsVoiceSettingsUnion) GetPrecision() *string {
	if vt := u.OfResemble; vt != nil {
		return (*string)(&vt.Precision)
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionStartConversationRelayParamsVoiceSettingsUnion) GetSampleRate() *string {
	if vt := u.OfResemble; vt != nil {
		return (*string)(&vt.SampleRate)
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionStartConversationRelayParamsVoiceSettingsUnion) GetType() *string {
	if vt := u.OfElevenlabs; vt != nil {
		return (*string)(&vt.Type)
	} else if vt := u.OfTelnyx; vt != nil {
		return (*string)(&vt.Type)
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionStartConversationRelayParamsVoiceSettingsUnion) GetAPIKeyRef() *string {
	if vt := u.OfElevenlabs; vt != nil && vt.APIKeyRef.Valid() {
		return &vt.APIKeyRef.Value
	} else if vt := u.OfAzure; vt != nil && vt.APIKeyRef.Valid() {
		return &vt.APIKeyRef.Value
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionStartConversationRelayParamsVoiceSettingsUnion) GetVoiceSpeed() *float64 {
	if vt := u.OfTelnyx; vt != nil && vt.VoiceSpeed.Valid() {
		return &vt.VoiceSpeed.Value
	} else if vt := u.OfRime; vt != nil && vt.VoiceSpeed.Valid() {
		return &vt.VoiceSpeed.Value
...
func init() {
	apijson.RegisterUnion[CallActionStartConversationRelayParamsVoiceSettingsUnion](
		"type",
		apijson.Discriminator[ElevenLabsVoiceSettingsParam]("elevenlabs"),
		apijson.Discriminator[TelnyxVoiceSettingsParam]("telnyx"),
		apijson.Discriminator[AwsVoiceSettingsParam]("aws"),
...
// `deepgram/nova-3` - `Deepgram Nova-3`. Note: `deepgram/nova-3` supports only
// `en` and `en-{Region}` languages.
type CallActionStartRecordingParamsTranscriptionEngine string

const (
	CallActionStartRecordingParamsTranscriptionEngineA             CallActionStartRecordingParamsTranscriptionEngine = "A"
	CallActionStartRecordingParamsTranscriptionEngineB             CallActionStartRecordingParamsTranscriptionEngine = "B"
...
type CallActionStopConversationRelayParams struct {
	// Use this field to add state to subsequent webhooks. It must be a valid Base-64
	// encoded string.
	ClientState param.Opt[string] `json:"client_state,omitzero"`
	// Use this field to avoid duplicate commands. Telnyx will ignore any command with
...
func (r CallActionStopConversationRelayParams) MarshalJSON() (data []byte, err error) {
	type shadow CallActionStopConversationRelayParams
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *CallActionStopConversationRelayParams) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
