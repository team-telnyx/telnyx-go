...
type AIAssistantJoinParticipantParam struct {
	...
	OnHangup AIAssistantJoinParticipantOnHangup `json:"on_hangup,omitzero"`
	paramObj
}

func (r AIAssistantJoinParticipantParam) MarshalJSON() (data []byte, err error) {
	type shadow AIAssistantJoinParticipantParam
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *AIAssistantJoinParticipantParam) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// The role of the participant in the conversation.
type AIAssistantJoinParticipantRole string

const (
	AIAssistantJoinParticipantRoleUser AIAssistantJoinParticipantRole = "user"
)

// Determines what happens to the conversation when this participant hangs up.
type AIAssistantJoinParticipantOnHangup string

const (
	AIAssistantJoinParticipantOnHangupContinueConversation AIAssistantJoinParticipantOnHangup = "continue_conversation"
	AIAssistantJoinParticipantOnHangupEndConversation      AIAssistantJoinParticipantOnHangup = "end_conversation"
)
...
type AssistantMessageParam struct {
	...
	//
	// Any of "assistant".
	Role AssistantMessageRole `json:"role,omitzero" api:"required"`
	// The contents of the assistant message. Required unless `tool_calls`
	Content param.Opt[string] `json:"content,omitzero"`
	// Metadata to add to the message
	Metadata map[string]any `json:"metadata,omitzero"`
	// The tool calls generated by the model, such as function calls.
	ToolCalls []AssistantMessageToolCallParam `json:"tool_calls,omitzero"`
	paramObj
}

func (r AssistantMessageParam) MarshalJSON() (data []byte, err error) {
	type shadow AssistantMessageParam
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *AssistantMessageParam) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type AssistantMessageToolCallParam struct {
	// The ID of the tool call.
	ID string `json:"id" api:"required"`
	// The function that the model called.
	Function AssistantMessageToolCallsFunctionParam `json:"function,omitzero" api:"required"`
...
func (r AssistantMessageToolCallParam) MarshalJSON() (data []byte, err error) {
	type shadow AssistantMessageToolCallParam
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *AssistantMessageToolCallParam) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

func init() {
	apijson.RegisterFieldValidator[AssistantMessageToolCallParam](
		"type", "function",
	)
}
...
type AssistantMessageToolCallsFunctionParam struct {
	// The name of the function to call.
	Name string `json:"name" api:"required"`
	paramObj
}

func (r AssistantMessageToolCallsFunctionParam) MarshalJSON() (data []byte, err error) {
	type shadow AssistantMessageToolCallsFunctionParam
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *AssistantMessageToolCallsFunctionParam) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type ConversationRelayInterruptible string

const (
	ConversationRelayInterruptibleNone   ConversationRelayInterruptible = "none"
	ConversationRelayInterruptibleAny    ConversationRelayInterruptible = "any"
	ConversationRelayInterruptibleSpeech ConversationRelayInterruptible = "speech"
	ConversationRelayInterruptibleDtmf   ConversationRelayInterruptible = "dtmf"
)
...
type DeveloperMessageParam struct {
	// The contents of the developer message.
	Content string `json:"content" api:"required"`
	// The role of the messages author, in this case developer.
	//
	// Any of "developer".
	Role DeveloperMessageRole `json:"role,omitzero" api:"required"`
	// Metadata to add to the message
	Metadata map[string]any `json:"metadata,omitzero"`
	paramObj
}

func (r DeveloperMessageParam) MarshalJSON() (data []byte, err error) {
	type shadow DeveloperMessageParam
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *DeveloperMessageParam) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
const (
	DeveloperMessageRoleDeveloper DeveloperMessageRole = "developer"
)
...
// The property Type is required.
type SonioxVoiceSettingsParam struct {
	// Voice settings provider type
	//
	// Any of "soniox".
	Type SonioxVoiceSettingsType `json:"type,omitzero" api:"required"`
...
func (r SonioxVoiceSettingsParam) MarshalJSON() (data []byte, err error) {
	type shadow SonioxVoiceSettingsParam
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *SonioxVoiceSettingsParam) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// Voice settings provider type
type SonioxVoiceSettingsType string

const (
	SonioxVoiceSettingsTypeSoniox SonioxVoiceSettingsType = "soniox"
)
...
type SystemMessageParam struct {
	...
	//
	// Any of "system".
	Role SystemMessageRole `json:"role,omitzero" api:"required"`
	// Metadata to add to the message
	Metadata map[string]any `json:"metadata,omitzero"`
	paramObj
}
...
type ToolMessageParam struct {
	...
	//
	// Any of "tool".
	Role ToolMessageRole `json:"role,omitzero" api:"required"`
...
func (r ToolMessageParam) MarshalJSON() (data []byte, err error) {
	type shadow ToolMessageParam
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *ToolMessageParam) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
func (r TranscriptionEngineParakeetConfigParam) MarshalJSON() (data []byte, err error) {
	type shadow TranscriptionEngineParakeetConfigParam
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *TranscriptionEngineParakeetConfigParam) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// Engine identifier for Parakeet transcription service
type TranscriptionEngineParakeetConfigTranscriptionEngine string

const (
	TranscriptionEngineParakeetConfigTranscriptionEngineParakeet TranscriptionEngineParakeetConfigTranscriptionEngine = "Parakeet"
)
...
type UserMessageParam struct {
	...
	//
	// Any of "user".
	Role UserMessageRole `json:"role,omitzero" api:"required"`
	// Metadata to add to the message
	Metadata map[string]any `json:"metadata,omitzero"`
	paramObj
}
...
type CallActionAddAIAssistantMessagesParamsMessageUnion struct {
	...
	OfAssistant *AssistantMessageParam `json:",omitzero,inline"`
	OfTool      *ToolMessageParam      `json:",omitzero,inline"`
	OfSystem    *SystemMessageParam    `json:",omitzero,inline"`
	OfDeveloper *DeveloperMessageParam `json:",omitzero,inline"`
	paramUnion
}
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionAddAIAssistantMessagesParamsMessageUnion) GetToolCalls() []AssistantMessageToolCallParam {
...
func init() {
	apijson.RegisterUnion[CallActionAddAIAssistantMessagesParamsMessageUnion](
		...
		apijson.Discriminator[AssistantMessageParam]("assistant"),
		apijson.Discriminator[ToolMessageParam]("tool"),
		apijson.Discriminator[SystemMessageParam]("system"),
		apijson.Discriminator[DeveloperMessageParam]("developer"),
	)
}
...
type CallActionAnswerParams struct {
	...
	ConversationRelayConfig ConversationRelayEmbeddedConfigParam `json:"conversation_relay_config,omitzero"`
	...
	WebhookRetriesPolicies map[string]CallActionAnswerParamsWebhookRetriesPolicies `json:"webhook_retries_policies,omitzero"`
...
type CallActionAnswerParamsWebhookRetriesPolicies struct {
...
func (r CallActionAnswerParamsWebhookRetriesPolicies) MarshalJSON() (data []byte, err error) {
	type shadow CallActionAnswerParamsWebhookRetriesPolicies
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *CallActionAnswerParamsWebhookRetriesPolicies) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionGatherUsingAIParamsVoiceSettingsUnion) GetReduceSilence() *bool {
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionGatherUsingAIParamsVoiceSettingsUnion) GetSpeed() *float64 {
	if vt := u.OfSoniox; vt != nil && vt.Speed.Valid() {
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionGatherUsingSpeakParamsVoiceSettingsUnion) GetReduceSilence() *bool {
	if vt := u.OfSoniox; vt != nil && vt.ReduceSilence.Valid() {
		return &vt.ReduceSilence.Value
	}
	return nil
...
type CallActionJoinAIAssistantParams struct {
	...
	Participant    AIAssistantJoinParticipantParam `json:"participant,omitzero" api:"required"`
	// Use this field to add state to every subsequent webhook. It must be a valid
	// Base-64 encoded string.
	ClientState param.Opt[string] `json:"client_state,omitzero"`
	// Use this field to avoid duplicate commands. Telnyx will ignore any command with
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionSpeakParamsVoiceSettingsUnion) GetReduceSilence() *bool {
	if vt := u.OfSoniox; vt != nil && vt.ReduceSilence.Valid() {
		return &vt.ReduceSilence.Value
	}
	return nil
...
type CallActionStartAIAssistantParams struct {
	...
	Participants []AIAssistantJoinParticipantParam `json:"participants,omitzero"`
	// The settings associated with speech to text for the voice assistant. This is
	// only relevant if the assistant uses a text-to-text language model. Any assistant
	// using a model with native audio support (e.g. `fixie-ai/ultravox-v0_4`) will
	// ignore this field.
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionStartAIAssistantParamsMessageHistoryUnion) GetToolCalls() []AssistantMessageToolCallParam {
	if vt := u.OfAssistant; vt != nil {
		return vt.ToolCalls
	}
	return nil
...
type CallActionStartConversationRelayParams struct {
	...
	Interruptible ConversationRelayInterruptible `json:"interruptible,omitzero"`
	// Controls when caller input can interrupt assistant speech. `any` allows speech
	// or DTMF interruptions; `none` disables interruptions; `speech` allows speech
	// only; `dtmf` allows DTMF only.
	//
	// Any of "none", "any", "speech", "dtmf".
	InterruptibleGreeting ConversationRelayInterruptible `json:"interruptible_greeting,omitzero"`
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallActionStartConversationRelayParamsVoiceSettingsUnion) GetReduceSilence() *bool {
	if vt := u.OfSoniox; vt != nil && vt.ReduceSilence.Valid() {
		return &vt.ReduceSilence.Value
	}
	return nil
...
type CallActionTransferParams struct {
	...
	// `retries_ms` specifying the delays between retry attempts in milliseconds.
	// Maximum 5 retries, total delay cannot exceed 60 seconds.
	WebhookRetriesPolicies map[string]CallActionTransferParamsWebhookRetriesPolicies `json:"webhook_retries_policies,omitzero"`
	// HTTP request type used for `webhook_url`.
	//
	// Any of "POST", "GET".
...
type CallActionTransferParamsWebhookRetriesPolicies struct {
	// Array of delays in milliseconds between retry attempts. Total sum cannot exceed
	// 60000ms.
	RetriesMs []int64 `json:"retries_ms,omitzero"`
	paramObj
...
func (r CallActionTransferParamsWebhookRetriesPolicies) MarshalJSON() (data []byte, err error) {
	type shadow CallActionTransferParamsWebhookRetriesPolicies
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *CallActionTransferParamsWebhookRetriesPolicies) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
