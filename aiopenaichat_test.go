...
func TestAIOpenAIChatNewCompletionWithOptionalParams(t *testing.T) {
	...
	_, err := client.AI.OpenAI.Chat.NewCompletion(context.TODO(), telnyx.AIOpenAIChatNewCompletionParams{
		ChatCompletionRequest: telnyx.ChatCompletionRequestParam{
			...
			ResponseFormat: telnyx.ChatCompletionRequestResponseFormatUnionParam{
				OfResponseFormatText: &telnyx.ChatCompletionRequestResponseFormatResponseFormatTextParam{},
			},
			Seed:        telnyx.Int(0),
