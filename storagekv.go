...
// `provision_ok`.
func (r *StorageKvService) New(ctx context.Context, body StorageKvNewParams, opts ...option.RequestOption) (res *KvNamespaceResponseWrapper, err error) {
...
func (r *StorageKvService) Get(ctx context.Context, id string, opts ...option.RequestOption) (res *KvNamespaceResponseWrapper, err error) {
	opts = slices.Concat(r.Options, opts)
	if id == "" {
...
func (r *StorageKvService) List(ctx context.Context, query StorageKvListParams, opts ...option.RequestOption) (res *pagination.DefaultFlatPagination[KvNamespace], err error) {
...
// Lists the KV namespaces for the authenticated user's organization. Results use
// page-based pagination (`page[number]`/`page[size]`).
func (r *StorageKvService) ListAutoPaging(ctx context.Context, query StorageKvListParams, opts ...option.RequestOption) *pagination.DefaultFlatPaginationAutoPager[KvNamespace] {
...
func (r *StorageKvService) Delete(ctx context.Context, id string, opts ...option.RequestOption) (res *KvNamespaceResponseWrapper, err error) {
	opts = slices.Concat(r.Options, opts)
	if id == "" {
		err = errors.New("missing required id parameter")
		return nil, err
...
type KvNamespace struct {
	...
	// "delete_failed".
	Status    KvNamespaceStatus `json:"status"`
...
func (r KvNamespace) RawJSON() string { return r.JSON.raw }
func (r *KvNamespace) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// Provisioning status. A namespace is usable once `status` is `provision_ok`. Once
// deletion completes, the namespace no longer appears in the API.
type KvNamespaceStatus string

const (
	KvNamespaceStatusPending         KvNamespaceStatus = "pending"
	KvNamespaceStatusProvisionOk     KvNamespaceStatus = "provision_ok"
	KvNamespaceStatusProvisionFailed KvNamespaceStatus = "provision_failed"
	KvNamespaceStatusDeleting        KvNamespaceStatus = "deleting"
	KvNamespaceStatusDeleteFailed    KvNamespaceStatus = "delete_failed"
)

type KvNamespaceResponseWrapper struct {
	Data KvNamespace `json:"data"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		Data        respjson.Field
		ExtraFields map[string]respjson.Field
...
// Returns the unmodified JSON received from the API
func (r KvNamespaceResponseWrapper) RawJSON() string { return r.JSON.raw }
func (r *KvNamespaceResponseWrapper) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
