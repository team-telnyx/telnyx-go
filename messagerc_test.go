...
func TestMessageRcGenerateDeeplinkWithOptionalParams(t *testing.T) {
...
func TestMessageRcSendWithOptionalParams(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Messages.Rcs.Send(context.TODO(), telnyx.MessageRcSendParams{
		AgentID: "Agent007",
		...
		To:                 "+13125551234",
		MmsFallback: telnyx.MessageRcSendParamsMmsFallback{
			From:      telnyx.String("+13125551234"),
			MediaURLs: []string{"string"},
			Subject:   telnyx.String("Test Message"),
			Text:      telnyx.String("Hello world!"),
		},
		SMSFallback: telnyx.MessageRcSendParamsSMSFallback{
			From: telnyx.String("+13125551234"),
			Text: telnyx.String("Hello world!"),
		},
		Type:       telnyx.MessageRcSendParamsTypeRcs,
