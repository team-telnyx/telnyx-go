...
func TestUacConnectionNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.UacConnections.New(context.TODO(), telnyx.UacConnectionNewParams{
		...
		Inbound: telnyx.UacInboundRequestParam{
			AniNumberFormat:          telnyx.UacInboundRequestAniNumberFormatPlusE164,
			ChannelLimit:             telnyx.Int(10),
			Codecs:                   []string{"G722"},
			DefaultRoutingMethod:     telnyx.UacInboundRequestDefaultRoutingMethodSequential,
			DnisNumberFormat:         telnyx.UacInboundRequestDnisNumberFormatPlusE164,
			...
			SimultaneousRinging:      telnyx.UacInboundRequestSimultaneousRingingDisabled,
			SipCompactHeadersEnabled: telnyx.Bool(true),
			SipRegion:                telnyx.UacInboundRequestSipRegionUs,
