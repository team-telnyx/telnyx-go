...
import (
	...
	"github.com/stainless-sdks/telnyx-go/internal"
...
func TestUserAgentHeader(t *testing.T) {
	...
	if userAgent != fmt.Sprintf("Telnyx/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.NumberOrders.New(context.Background(), telnyx.NumberOrderNewParams{
		PhoneNumbers: []telnyx.NumberOrderNewParamsPhoneNumber{{
			PhoneNumber: "+15558675309",
		}},
	})
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.NumberOrders.New(cancelCtx, telnyx.NumberOrderNewParams{
		PhoneNumbers: []telnyx.NumberOrderNewParamsPhoneNumber{{
			PhoneNumber: "+15558675309",
		}},
	})
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.NumberOrders.New(deadlineCtx, telnyx.NumberOrderNewParams{
			PhoneNumbers: []telnyx.NumberOrderNewParamsPhoneNumber{{
				PhoneNumber: "+15558675309",
			}},
		})
