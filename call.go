...
type CallDialParams struct {
	...
	// fields.
	Assistant CallDialParamsAssistant `json:"assistant,omitzero"`
...
type CallDialParamsAssistant struct {
	...
	DynamicVariables map[string]CallDialParamsAssistantDynamicVariableUnion `json:"dynamic_variables,omitzero"`
	...
	Tools []CallDialParamsAssistantToolUnion `json:"tools,omitzero"`
	paramObj
}

func (r CallDialParamsAssistant) MarshalJSON() (data []byte, err error) {
	type shadow CallDialParamsAssistant
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *CallDialParamsAssistant) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
//
// Use [param.IsOmitted] to confirm if a field is set.
type CallDialParamsAssistantDynamicVariableUnion struct {
	OfString param.Opt[string]  `json:",omitzero,inline"`
...
func (u CallDialParamsAssistantDynamicVariableUnion) MarshalJSON() ([]byte, error) {
	return param.MarshalUnion(u, u.OfString, u.OfFloat, u.OfBool)
}
func (u *CallDialParamsAssistantDynamicVariableUnion) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, u)
}

func (u *CallDialParamsAssistantDynamicVariableUnion) asAny() any {
	if !param.IsOmitted(u.OfString) {
		return &u.OfString.Value
...
//
// Use [param.IsOmitted] to confirm if a field is set.
type CallDialParamsAssistantToolUnion struct {
	OfBookAppointment   *CallDialParamsAssistantToolBookAppointment   `json:",omitzero,inline"`
	OfCheckAvailability *CallDialParamsAssistantToolCheckAvailability `json:",omitzero,inline"`
	...
	OfRetrieval         *CallDialParamsAssistantToolRetrieval         `json:",omitzero,inline"`
	paramUnion
}

func (u CallDialParamsAssistantToolUnion) MarshalJSON() ([]byte, error) {
...
func (u *CallDialParamsAssistantToolUnion) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, u)
}

func (u *CallDialParamsAssistantToolUnion) asAny() any {
...
func (u CallDialParamsAssistantToolUnion) GetBookAppointment() *CallDialParamsAssistantToolBookAppointmentBookAppointment {
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallDialParamsAssistantToolUnion) GetCheckAvailability() *CallDialParamsAssistantToolCheckAvailabilityCheckAvailability {
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallDialParamsAssistantToolUnion) GetWebhook() *WebhookToolWebhookParam {
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallDialParamsAssistantToolUnion) GetHangup() *HangupToolParams {
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallDialParamsAssistantToolUnion) GetTransfer() *TransferToolTransferParam {
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallDialParamsAssistantToolUnion) GetRetrieval() *CallDialParamsAssistantToolRetrievalRetrieval {
...
// Returns a pointer to the underlying variant's property, if present.
func (u CallDialParamsAssistantToolUnion) GetType() *string {
	if vt := u.OfBookAppointment; vt != nil {
...
func init() {
	apijson.RegisterUnion[CallDialParamsAssistantToolUnion](
		"type",
		apijson.Discriminator[CallDialParamsAssistantToolBookAppointment]("book_appointment"),
		apijson.Discriminator[CallDialParamsAssistantToolCheckAvailability]("check_availability"),
		...
		apijson.Discriminator[CallDialParamsAssistantToolRetrieval]("retrieval"),
	)
}

// The properties BookAppointment, Type are required.
type CallDialParamsAssistantToolBookAppointment struct {
	BookAppointment CallDialParamsAssistantToolBookAppointmentBookAppointment `json:"book_appointment,omitzero" api:"required"`
...
func (r CallDialParamsAssistantToolBookAppointment) MarshalJSON() (data []byte, err error) {
	type shadow CallDialParamsAssistantToolBookAppointment
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *CallDialParamsAssistantToolBookAppointment) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// The properties APIKeyRef, EventTypeID are required.
type CallDialParamsAssistantToolBookAppointmentBookAppointment struct {
...
func (r CallDialParamsAssistantToolBookAppointmentBookAppointment) MarshalJSON() (data []byte, err error) {
	type shadow CallDialParamsAssistantToolBookAppointmentBookAppointment
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *CallDialParamsAssistantToolBookAppointmentBookAppointment) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// The properties CheckAvailability, Type are required.
type CallDialParamsAssistantToolCheckAvailability struct {
	CheckAvailability CallDialParamsAssistantToolCheckAvailabilityCheckAvailability `json:"check_availability,omitzero" api:"required"`
...
func (r CallDialParamsAssistantToolCheckAvailability) MarshalJSON() (data []byte, err error) {
	type shadow CallDialParamsAssistantToolCheckAvailability
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *CallDialParamsAssistantToolCheckAvailability) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// The properties APIKeyRef, EventTypeID are required.
type CallDialParamsAssistantToolCheckAvailabilityCheckAvailability struct {
	// Reference to an integration secret that contains your Cal.com API key. You would
	// pass the `identifier` for an integration secret
	// [/v2/integration_secrets](https://developers.telnyx.com/api/secrets-manager/integration-secrets/create-integration-secret)
	// that refers to your Cal.com API key.
...
func (r CallDialParamsAssistantToolCheckAvailabilityCheckAvailability) MarshalJSON() (data []byte, err error) {
	type shadow CallDialParamsAssistantToolCheckAvailabilityCheckAvailability
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *CallDialParamsAssistantToolCheckAvailabilityCheckAvailability) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// The properties Retrieval, Type are required.
type CallDialParamsAssistantToolRetrieval struct {
	Retrieval CallDialParamsAssistantToolRetrievalRetrieval `json:"retrieval,omitzero" api:"required"`
	// This field can be elided, and will marshal its zero value as "retrieval".
	Type constant.Retrieval `json:"type" default:"retrieval"`
	paramObj
}

func (r CallDialParamsAssistantToolRetrieval) MarshalJSON() (data []byte, err error) {
	type shadow CallDialParamsAssistantToolRetrieval
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *CallDialParamsAssistantToolRetrieval) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// The property BucketIDs is required.
type CallDialParamsAssistantToolRetrievalRetrieval struct {
...
func (r CallDialParamsAssistantToolRetrievalRetrieval) MarshalJSON() (data []byte, err error) {
	type shadow CallDialParamsAssistantToolRetrievalRetrieval
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *CallDialParamsAssistantToolRetrievalRetrieval) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
