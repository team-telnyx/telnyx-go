...
func TestVerificationTriggerWhatsappVerificationWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Verifications.TriggerWhatsappVerification(context.TODO(), telnyx.VerificationTriggerWhatsappVerificationParams{
		PhoneNumber:     "+13035551234",
		VerifyProfileID: "12ade33a-21c0-473b-b055-b3c836e1c292",
		CustomCode:      telnyx.String("43612"),
		TimeoutSecs:     telnyx.Int(300),
