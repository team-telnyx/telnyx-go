...
func TestShortCodeGet(t *testing.T) {
	...
	_, err := client.ShortCodes.Get(context.TODO(), "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
	if err != nil {
...
func TestShortCodeUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.ShortCodes.Update(
		context.TODO(),
...
func TestShortCodeListWithOptionalParams(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.ShortCodes.List(context.TODO(), telnyx.ShortCodeListParams{
