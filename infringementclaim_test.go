...
func TestInfringementClaimGet(t *testing.T) {
	...
	_, err := client.InfringementClaims.Get(context.TODO(), "e379fbc8-cd83-4bef-a280-a0ac9d00dcf8")
	if err != nil {
...
func TestInfringementClaimContestWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
