...
// checks if the CallForkStarted type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CallForkStarted{}

// CallForkStarted struct for CallForkStarted
...
func (o *CallForkStarted) GetPayload() CallForkStartedPayload {
	if o == nil || IsNil(o.Payload) {
		var ret CallForkStartedPayload
		return ret
	}
	return *o.Payload
}
...
// SetPayload gets a reference to the given CallForkStartedPayload and assigns it to the Payload field.
func (o *CallForkStarted) SetPayload(v CallForkStartedPayload) {
	o.Payload = &v
}

func (o CallForkStarted) MarshalJSON() ([]byte, error) {
...
func (o CallForkStarted) ToMap() (map[string]interface{}, error) {
...
type NullableCallForkStarted struct {
	value *CallForkStarted
	isSet bool
}

func (v NullableCallForkStarted) Get() *CallForkStarted {
	return v.value
}

func (v *NullableCallForkStarted) Set(val *CallForkStarted) {
	v.value = val
	v.isSet = true
}

func (v NullableCallForkStarted) IsSet() bool {
	return v.isSet
}

func (v *NullableCallForkStarted) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCallForkStarted(val *CallForkStarted) *NullableCallForkStarted {
	return &NullableCallForkStarted{value: val, isSet: true}
}

func (v NullableCallForkStarted) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCallForkStarted) UnmarshalJSON(src []byte) error {
	v.isSet = true
