...
// checks if the CallReferCompleted type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CallReferCompleted{}

// CallReferCompleted struct for CallReferCompleted
...
func (o *CallReferCompleted) GetPayload() CallReferCompletedPayload {
	if o == nil || IsNil(o.Payload) {
		var ret CallReferCompletedPayload
		return ret
	}
	return *o.Payload
}
...
// SetPayload gets a reference to the given CallReferCompletedPayload and assigns it to the Payload field.
func (o *CallReferCompleted) SetPayload(v CallReferCompletedPayload) {
	o.Payload = &v
}

func (o CallReferCompleted) MarshalJSON() ([]byte, error) {
...
func (o CallReferCompleted) ToMap() (map[string]interface{}, error) {
...
type NullableCallReferCompleted struct {
	value *CallReferCompleted
	isSet bool
}

func (v NullableCallReferCompleted) Get() *CallReferCompleted {
	return v.value
}

func (v *NullableCallReferCompleted) Set(val *CallReferCompleted) {
	v.value = val
	v.isSet = true
}

func (v NullableCallReferCompleted) IsSet() bool {
	return v.isSet
}

func (v *NullableCallReferCompleted) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCallReferCompleted(val *CallReferCompleted) *NullableCallReferCompleted {
	return &NullableCallReferCompleted{value: val, isSet: true}
}

func (v NullableCallReferCompleted) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCallReferCompleted) UnmarshalJSON(src []byte) error {
	v.isSet = true
