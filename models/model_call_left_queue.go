...
// checks if the CallLeftQueue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CallLeftQueue{}

// CallLeftQueue struct for CallLeftQueue
type CallLeftQueue struct {
	...
	Payload *CallLeftQueuePayload `json:"payload,omitempty"`
}
...
// SetPayload gets a reference to the given CallLeftQueuePayload and assigns it to the Payload field.
func (o *CallLeftQueue) SetPayload(v CallLeftQueuePayload) {
	o.Payload = &v
}

func (o CallLeftQueue) MarshalJSON() ([]byte, error) {
...
func (o CallLeftQueue) ToMap() (map[string]interface{}, error) {
...
type NullableCallLeftQueue struct {
	value *CallLeftQueue
	isSet bool
}

func (v NullableCallLeftQueue) Get() *CallLeftQueue {
	return v.value
}

func (v *NullableCallLeftQueue) Set(val *CallLeftQueue) {
	v.value = val
	v.isSet = true
}

func (v NullableCallLeftQueue) IsSet() bool {
	return v.isSet
}

func (v *NullableCallLeftQueue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCallLeftQueue(val *CallLeftQueue) *NullableCallLeftQueue {
	return &NullableCallLeftQueue{value: val, isSet: true}
}

func (v NullableCallLeftQueue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCallLeftQueue) UnmarshalJSON(src []byte) error {
	v.isSet = true
