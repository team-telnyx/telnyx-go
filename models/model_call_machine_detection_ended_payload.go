...
// checks if the CallMachineDetectionEndedPayload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CallMachineDetectionEndedPayload{}

// CallMachineDetectionEndedPayload struct for CallMachineDetectionEndedPayload
...
func NewCallMachineDetectionEndedPayload() *CallMachineDetectionEndedPayload {
	this := CallMachineDetectionEndedPayload{}
	return &this
}
...
func (o CallMachineDetectionEndedPayload) MarshalJSON() ([]byte, error) {
...
func (o CallMachineDetectionEndedPayload) ToMap() (map[string]interface{}, error) {
...
type NullableCallMachineDetectionEndedPayload struct {
	value *CallMachineDetectionEndedPayload
	isSet bool
}

func (v NullableCallMachineDetectionEndedPayload) Get() *CallMachineDetectionEndedPayload {
	return v.value
}

func (v *NullableCallMachineDetectionEndedPayload) Set(val *CallMachineDetectionEndedPayload) {
	v.value = val
	v.isSet = true
}

func (v NullableCallMachineDetectionEndedPayload) IsSet() bool {
	return v.isSet
}

func (v *NullableCallMachineDetectionEndedPayload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCallMachineDetectionEndedPayload(val *CallMachineDetectionEndedPayload) *NullableCallMachineDetectionEndedPayload {
	return &NullableCallMachineDetectionEndedPayload{value: val, isSet: true}
}

func (v NullableCallMachineDetectionEndedPayload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCallMachineDetectionEndedPayload) UnmarshalJSON(src []byte) error {
	v.isSet = true
