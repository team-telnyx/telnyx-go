...
// checks if the CallSiprecFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CallSiprecFailed{}

// CallSiprecFailed struct for CallSiprecFailed
type CallSiprecFailed struct {
	...
	Payload *CallSiprecFailedPayload `json:"payload,omitempty"`
}
...
func (o *CallSiprecFailed) GetPayload() CallSiprecFailedPayload {
	if o == nil || IsNil(o.Payload) {
		var ret CallSiprecFailedPayload
		return ret
	}
	return *o.Payload
}
...
// SetPayload gets a reference to the given CallSiprecFailedPayload and assigns it to the Payload field.
func (o *CallSiprecFailed) SetPayload(v CallSiprecFailedPayload) {
	o.Payload = &v
}

func (o CallSiprecFailed) MarshalJSON() ([]byte, error) {
...
func (o CallSiprecFailed) ToMap() (map[string]interface{}, error) {
...
type NullableCallSiprecFailed struct {
	value *CallSiprecFailed
	isSet bool
}

func (v NullableCallSiprecFailed) Get() *CallSiprecFailed {
	return v.value
}

func (v *NullableCallSiprecFailed) Set(val *CallSiprecFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableCallSiprecFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableCallSiprecFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCallSiprecFailed(val *CallSiprecFailed) *NullableCallSiprecFailed {
	return &NullableCallSiprecFailed{value: val, isSet: true}
}

func (v NullableCallSiprecFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCallSiprecFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
