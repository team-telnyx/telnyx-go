...
// checks if the CreateTexmlApplicationRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTexmlApplicationRequest{}

// CreateTexmlApplicationRequest struct for CreateTexmlApplicationRequest
...
type _CreateTexmlApplicationRequest CreateTexmlApplicationRequest
...
func NewCreateTexmlApplicationRequest(friendlyName string, voiceUrl string) *CreateTexmlApplicationRequest {
	this := CreateTexmlApplicationRequest{}
...
func (o CreateTexmlApplicationRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateTexmlApplicationRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CreateTexmlApplicationRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateTexmlApplicationRequest := _CreateTexmlApplicationRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateTexmlApplicationRequest)

	if err != nil {
		return err
	}

	*o = CreateTexmlApplicationRequest(varCreateTexmlApplicationRequest)

	return err
}

type NullableCreateTexmlApplicationRequest struct {
	value *CreateTexmlApplicationRequest
	isSet bool
}

func (v NullableCreateTexmlApplicationRequest) Get() *CreateTexmlApplicationRequest {
	return v.value
}

func (v *NullableCreateTexmlApplicationRequest) Set(val *CreateTexmlApplicationRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTexmlApplicationRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTexmlApplicationRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTexmlApplicationRequest(val *CreateTexmlApplicationRequest) *NullableCreateTexmlApplicationRequest {
	return &NullableCreateTexmlApplicationRequest{value: val, isSet: true}
}

func (v NullableCreateTexmlApplicationRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTexmlApplicationRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
