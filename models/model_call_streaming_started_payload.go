...
// checks if the CallStreamingStartedPayload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CallStreamingStartedPayload{}

// CallStreamingStartedPayload struct for CallStreamingStartedPayload
...
func NewCallStreamingStartedPayload() *CallStreamingStartedPayload {
	this := CallStreamingStartedPayload{}
	return &this
}
...
func (o CallStreamingStartedPayload) MarshalJSON() ([]byte, error) {
...
func (o CallStreamingStartedPayload) ToMap() (map[string]interface{}, error) {
...
type NullableCallStreamingStartedPayload struct {
	value *CallStreamingStartedPayload
	isSet bool
}

func (v NullableCallStreamingStartedPayload) Get() *CallStreamingStartedPayload {
	return v.value
}

func (v *NullableCallStreamingStartedPayload) Set(val *CallStreamingStartedPayload) {
	v.value = val
	v.isSet = true
}

func (v NullableCallStreamingStartedPayload) IsSet() bool {
	return v.isSet
}

func (v *NullableCallStreamingStartedPayload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCallStreamingStartedPayload(val *CallStreamingStartedPayload) *NullableCallStreamingStartedPayload {
	return &NullableCallStreamingStartedPayload{value: val, isSet: true}
}

func (v NullableCallStreamingStartedPayload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCallStreamingStartedPayload) UnmarshalJSON(src []byte) error {
	v.isSet = true
