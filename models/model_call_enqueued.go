...
// checks if the CallEnqueued type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CallEnqueued{}

// CallEnqueued struct for CallEnqueued
type CallEnqueued struct {
	...
	Payload *CallEnqueuedPayload `json:"payload,omitempty"`
}
...
// SetPayload gets a reference to the given CallEnqueuedPayload and assigns it to the Payload field.
func (o *CallEnqueued) SetPayload(v CallEnqueuedPayload) {
	o.Payload = &v
}

func (o CallEnqueued) MarshalJSON() ([]byte, error) {
...
func (o CallEnqueued) ToMap() (map[string]interface{}, error) {
...
type NullableCallEnqueued struct {
	value *CallEnqueued
	isSet bool
}

func (v NullableCallEnqueued) Get() *CallEnqueued {
	return v.value
}

func (v *NullableCallEnqueued) Set(val *CallEnqueued) {
	v.value = val
	v.isSet = true
}

func (v NullableCallEnqueued) IsSet() bool {
	return v.isSet
}

func (v *NullableCallEnqueued) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCallEnqueued(val *CallEnqueued) *NullableCallEnqueued {
	return &NullableCallEnqueued{value: val, isSet: true}
}

func (v NullableCallEnqueued) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCallEnqueued) UnmarshalJSON(src []byte) error {
	v.isSet = true
