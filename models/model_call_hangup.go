...
// checks if the CallHangup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CallHangup{}

// CallHangup struct for CallHangup
...
// SetPayload gets a reference to the given CallHangupPayload and assigns it to the Payload field.
func (o *CallHangup) SetPayload(v CallHangupPayload) {
	o.Payload = &v
}

func (o CallHangup) MarshalJSON() ([]byte, error) {
...
func (o CallHangup) ToMap() (map[string]interface{}, error) {
...
type NullableCallHangup struct {
	value *CallHangup
	isSet bool
}

func (v NullableCallHangup) Get() *CallHangup {
	return v.value
}

func (v *NullableCallHangup) Set(val *CallHangup) {
	v.value = val
	v.isSet = true
}

func (v NullableCallHangup) IsSet() bool {
	return v.isSet
}

func (v *NullableCallHangup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCallHangup(val *CallHangup) *NullableCallHangup {
	return &NullableCallHangup{value: val, isSet: true}
}

func (v NullableCallHangup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCallHangup) UnmarshalJSON(src []byte) error {
	v.isSet = true
