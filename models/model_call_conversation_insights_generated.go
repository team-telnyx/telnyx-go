...
// checks if the CallConversationInsightsGenerated type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CallConversationInsightsGenerated{}

// CallConversationInsightsGenerated struct for CallConversationInsightsGenerated
type CallConversationInsightsGenerated struct {
	...
	Payload *CallConversationInsightsGeneratedPayload `json:"payload,omitempty"`
}
...
func NewCallConversationInsightsGenerated() *CallConversationInsightsGenerated {
	this := CallConversationInsightsGenerated{}
	return &this
}
...
func (o *CallConversationInsightsGenerated) GetPayload() CallConversationInsightsGeneratedPayload {
	if o == nil || IsNil(o.Payload) {
		var ret CallConversationInsightsGeneratedPayload
		return ret
	}
	return *o.Payload
}
...
// SetPayload gets a reference to the given CallConversationInsightsGeneratedPayload and assigns it to the Payload field.
func (o *CallConversationInsightsGenerated) SetPayload(v CallConversationInsightsGeneratedPayload) {
	o.Payload = &v
}

func (o CallConversationInsightsGenerated) MarshalJSON() ([]byte, error) {
...
func (o CallConversationInsightsGenerated) ToMap() (map[string]interface{}, error) {
...
type NullableCallConversationInsightsGenerated struct {
	value *CallConversationInsightsGenerated
	isSet bool
}

func (v NullableCallConversationInsightsGenerated) Get() *CallConversationInsightsGenerated {
	return v.value
}

func (v *NullableCallConversationInsightsGenerated) Set(val *CallConversationInsightsGenerated) {
	v.value = val
	v.isSet = true
}

func (v NullableCallConversationInsightsGenerated) IsSet() bool {
	return v.isSet
}

func (v *NullableCallConversationInsightsGenerated) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCallConversationInsightsGenerated(val *CallConversationInsightsGenerated) *NullableCallConversationInsightsGenerated {
	return &NullableCallConversationInsightsGenerated{value: val, isSet: true}
}

func (v NullableCallConversationInsightsGenerated) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCallConversationInsightsGenerated) UnmarshalJSON(src []byte) error {
	v.isSet = true
