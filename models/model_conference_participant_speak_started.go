...
// checks if the ConferenceParticipantSpeakStarted type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConferenceParticipantSpeakStarted{}

// ConferenceParticipantSpeakStarted struct for ConferenceParticipantSpeakStarted
...
func NewConferenceParticipantSpeakStarted() *ConferenceParticipantSpeakStarted {
	this := ConferenceParticipantSpeakStarted{}
	return &this
}
...
func (o ConferenceParticipantSpeakStarted) MarshalJSON() ([]byte, error) {
...
func (o ConferenceParticipantSpeakStarted) ToMap() (map[string]interface{}, error) {
...
type NullableConferenceParticipantSpeakStarted struct {
	value *ConferenceParticipantSpeakStarted
	isSet bool
}

func (v NullableConferenceParticipantSpeakStarted) Get() *ConferenceParticipantSpeakStarted {
	return v.value
}

func (v *NullableConferenceParticipantSpeakStarted) Set(val *ConferenceParticipantSpeakStarted) {
	v.value = val
	v.isSet = true
}

func (v NullableConferenceParticipantSpeakStarted) IsSet() bool {
	return v.isSet
}

func (v *NullableConferenceParticipantSpeakStarted) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConferenceParticipantSpeakStarted(val *ConferenceParticipantSpeakStarted) *NullableConferenceParticipantSpeakStarted {
	return &NullableConferenceParticipantSpeakStarted{value: val, isSet: true}
}

func (v NullableConferenceParticipantSpeakStarted) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConferenceParticipantSpeakStarted) UnmarshalJSON(src []byte) error {
	v.isSet = true
