...
// checks if the NumberOrderWithPhoneNumbers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NumberOrderWithPhoneNumbers{}

// NumberOrderWithPhoneNumbers struct for NumberOrderWithPhoneNumbers
type NumberOrderWithPhoneNumbers struct {
	...
	PhoneNumbers []NumberOrderPhoneNumber `json:"phone_numbers,omitempty"`
...
func NewNumberOrderWithPhoneNumbers() *NumberOrderWithPhoneNumbers {
	this := NumberOrderWithPhoneNumbers{}
	return &this
}
...
// SetPhoneNumbers gets a reference to the given []NumberOrderPhoneNumber and assigns it to the PhoneNumbers field.
...
func (o NumberOrderWithPhoneNumbers) MarshalJSON() ([]byte, error) {
...
func (o NumberOrderWithPhoneNumbers) ToMap() (map[string]interface{}, error) {
...
type NullableNumberOrderWithPhoneNumbers struct {
	value *NumberOrderWithPhoneNumbers
	isSet bool
}

func (v NullableNumberOrderWithPhoneNumbers) Get() *NumberOrderWithPhoneNumbers {
	return v.value
}

func (v *NullableNumberOrderWithPhoneNumbers) Set(val *NumberOrderWithPhoneNumbers) {
	v.value = val
	v.isSet = true
}

func (v NullableNumberOrderWithPhoneNumbers) IsSet() bool {
	return v.isSet
}

func (v *NullableNumberOrderWithPhoneNumbers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNumberOrderWithPhoneNumbers(val *NumberOrderWithPhoneNumbers) *NullableNumberOrderWithPhoneNumbers {
	return &NullableNumberOrderWithPhoneNumbers{value: val, isSet: true}
}

func (v NullableNumberOrderWithPhoneNumbers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNumberOrderWithPhoneNumbers) UnmarshalJSON(src []byte) error {
	v.isSet = true
