...
// checks if the CreateOutboundVoiceProfileRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateOutboundVoiceProfileRequest{}

// CreateOutboundVoiceProfileRequest struct for CreateOutboundVoiceProfileRequest
...
type _CreateOutboundVoiceProfileRequest CreateOutboundVoiceProfileRequest
...
func NewCreateOutboundVoiceProfileRequest(name string) *CreateOutboundVoiceProfileRequest {
	this := CreateOutboundVoiceProfileRequest{}
	this.Name = name
...
func (o *CreateOutboundVoiceProfileRequest) SetConcurrentCallLimitNil() {
...
func (o *CreateOutboundVoiceProfileRequest) SetBillingGroupIdNil() {
...
func (o CreateOutboundVoiceProfileRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateOutboundVoiceProfileRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CreateOutboundVoiceProfileRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateOutboundVoiceProfileRequest := _CreateOutboundVoiceProfileRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateOutboundVoiceProfileRequest)

	if err != nil {
		return err
	}

	*o = CreateOutboundVoiceProfileRequest(varCreateOutboundVoiceProfileRequest)

	return err
}

type NullableCreateOutboundVoiceProfileRequest struct {
	value *CreateOutboundVoiceProfileRequest
	isSet bool
}

func (v NullableCreateOutboundVoiceProfileRequest) Get() *CreateOutboundVoiceProfileRequest {
	return v.value
}

func (v *NullableCreateOutboundVoiceProfileRequest) Set(val *CreateOutboundVoiceProfileRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateOutboundVoiceProfileRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateOutboundVoiceProfileRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateOutboundVoiceProfileRequest(val *CreateOutboundVoiceProfileRequest) *NullableCreateOutboundVoiceProfileRequest {
	return &NullableCreateOutboundVoiceProfileRequest{value: val, isSet: true}
}

func (v NullableCreateOutboundVoiceProfileRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateOutboundVoiceProfileRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
