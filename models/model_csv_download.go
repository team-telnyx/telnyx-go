...
// checks if the CsvDownload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CsvDownload{}

// CsvDownload struct for CsvDownload
...
func (o CsvDownload) MarshalJSON() ([]byte, error) {
...
func (o CsvDownload) ToMap() (map[string]interface{}, error) {
...
type NullableCsvDownload struct {
	value *CsvDownload
	isSet bool
}

func (v NullableCsvDownload) Get() *CsvDownload {
	return v.value
}

func (v *NullableCsvDownload) Set(val *CsvDownload) {
	v.value = val
	v.isSet = true
}

func (v NullableCsvDownload) IsSet() bool {
	return v.isSet
}

func (v *NullableCsvDownload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCsvDownload(val *CsvDownload) *NullableCsvDownload {
	return &NullableCsvDownload{value: val, isSet: true}
}

func (v NullableCsvDownload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCsvDownload) UnmarshalJSON(src []byte) error {
	v.isSet = true
