...
// checks if the VerifyProfileCallResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VerifyProfileCallResponse{}

// VerifyProfileCallResponse struct for VerifyProfileCallResponse
...
func NewVerifyProfileCallResponse() *VerifyProfileCallResponse {
	this := VerifyProfileCallResponse{}
...
func (o VerifyProfileCallResponse) MarshalJSON() ([]byte, error) {
...
func (o VerifyProfileCallResponse) ToMap() (map[string]interface{}, error) {
...
type NullableVerifyProfileCallResponse struct {
	value *VerifyProfileCallResponse
	isSet bool
}

func (v NullableVerifyProfileCallResponse) Get() *VerifyProfileCallResponse {
	return v.value
}

func (v *NullableVerifyProfileCallResponse) Set(val *VerifyProfileCallResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVerifyProfileCallResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVerifyProfileCallResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVerifyProfileCallResponse(val *VerifyProfileCallResponse) *NullableVerifyProfileCallResponse {
	return &NullableVerifyProfileCallResponse{value: val, isSet: true}
}

func (v NullableVerifyProfileCallResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVerifyProfileCallResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
