...
// checks if the GlobalIpAssignment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GlobalIpAssignment{}

// GlobalIpAssignment struct for GlobalIpAssignment
...
func (o GlobalIpAssignment) MarshalJSON() ([]byte, error) {
...
func (o GlobalIpAssignment) ToMap() (map[string]interface{}, error) {
...
type NullableGlobalIpAssignment struct {
	value *GlobalIpAssignment
	isSet bool
}

func (v NullableGlobalIpAssignment) Get() *GlobalIpAssignment {
	return v.value
}

func (v *NullableGlobalIpAssignment) Set(val *GlobalIpAssignment) {
	v.value = val
	v.isSet = true
}

func (v NullableGlobalIpAssignment) IsSet() bool {
	return v.isSet
}

func (v *NullableGlobalIpAssignment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGlobalIpAssignment(val *GlobalIpAssignment) *NullableGlobalIpAssignment {
	return &NullableGlobalIpAssignment{value: val, isSet: true}
}

func (v NullableGlobalIpAssignment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGlobalIpAssignment) UnmarshalJSON(src []byte) error {
	v.isSet = true
