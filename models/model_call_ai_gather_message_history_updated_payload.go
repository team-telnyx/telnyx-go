...
// checks if the CallAIGatherMessageHistoryUpdatedPayload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CallAIGatherMessageHistoryUpdatedPayload{}

// CallAIGatherMessageHistoryUpdatedPayload struct for CallAIGatherMessageHistoryUpdatedPayload
...
func NewCallAIGatherMessageHistoryUpdatedPayload() *CallAIGatherMessageHistoryUpdatedPayload {
	this := CallAIGatherMessageHistoryUpdatedPayload{}
	return &this
}
...
func (o CallAIGatherMessageHistoryUpdatedPayload) MarshalJSON() ([]byte, error) {
...
func (o CallAIGatherMessageHistoryUpdatedPayload) ToMap() (map[string]interface{}, error) {
...
type NullableCallAIGatherMessageHistoryUpdatedPayload struct {
	value *CallAIGatherMessageHistoryUpdatedPayload
	isSet bool
}

func (v NullableCallAIGatherMessageHistoryUpdatedPayload) Get() *CallAIGatherMessageHistoryUpdatedPayload {
	return v.value
}

func (v *NullableCallAIGatherMessageHistoryUpdatedPayload) Set(val *CallAIGatherMessageHistoryUpdatedPayload) {
	v.value = val
	v.isSet = true
}

func (v NullableCallAIGatherMessageHistoryUpdatedPayload) IsSet() bool {
	return v.isSet
}

func (v *NullableCallAIGatherMessageHistoryUpdatedPayload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCallAIGatherMessageHistoryUpdatedPayload(val *CallAIGatherMessageHistoryUpdatedPayload) *NullableCallAIGatherMessageHistoryUpdatedPayload {
	return &NullableCallAIGatherMessageHistoryUpdatedPayload{value: val, isSet: true}
}

func (v NullableCallAIGatherMessageHistoryUpdatedPayload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCallAIGatherMessageHistoryUpdatedPayload) UnmarshalJSON(src []byte) error {
	v.isSet = true
