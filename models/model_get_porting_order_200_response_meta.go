...
// checks if the GetPortingOrder200ResponseMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPortingOrder200ResponseMeta{}

// GetPortingOrder200ResponseMeta struct for GetPortingOrder200ResponseMeta
type GetPortingOrder200ResponseMeta struct {
...
func NewGetPortingOrder200ResponseMeta() *GetPortingOrder200ResponseMeta {
	this := GetPortingOrder200ResponseMeta{}
	return &this
}
...
func (o GetPortingOrder200ResponseMeta) MarshalJSON() ([]byte, error) {
...
func (o GetPortingOrder200ResponseMeta) ToMap() (map[string]interface{}, error) {
...
type NullableGetPortingOrder200ResponseMeta struct {
	value *GetPortingOrder200ResponseMeta
	isSet bool
}

func (v NullableGetPortingOrder200ResponseMeta) Get() *GetPortingOrder200ResponseMeta {
	return v.value
}

func (v *NullableGetPortingOrder200ResponseMeta) Set(val *GetPortingOrder200ResponseMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPortingOrder200ResponseMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPortingOrder200ResponseMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPortingOrder200ResponseMeta(val *GetPortingOrder200ResponseMeta) *NullableGetPortingOrder200ResponseMeta {
	return &NullableGetPortingOrder200ResponseMeta{value: val, isSet: true}
}

func (v NullableGetPortingOrder200ResponseMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPortingOrder200ResponseMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
