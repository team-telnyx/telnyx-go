...
// checks if the CreateGroupMMSMessageRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateGroupMMSMessageRequest{}

// CreateGroupMMSMessageRequest struct for CreateGroupMMSMessageRequest
...
type _CreateGroupMMSMessageRequest CreateGroupMMSMessageRequest
...
func NewCreateGroupMMSMessageRequest(from string, to []string) *CreateGroupMMSMessageRequest {
	this := CreateGroupMMSMessageRequest{}
	this.From = from
	this.To = to
...
func (o CreateGroupMMSMessageRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateGroupMMSMessageRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CreateGroupMMSMessageRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateGroupMMSMessageRequest := _CreateGroupMMSMessageRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateGroupMMSMessageRequest)

	if err != nil {
		return err
	}

	*o = CreateGroupMMSMessageRequest(varCreateGroupMMSMessageRequest)

	return err
}

type NullableCreateGroupMMSMessageRequest struct {
	value *CreateGroupMMSMessageRequest
	isSet bool
}

func (v NullableCreateGroupMMSMessageRequest) Get() *CreateGroupMMSMessageRequest {
	return v.value
}

func (v *NullableCreateGroupMMSMessageRequest) Set(val *CreateGroupMMSMessageRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateGroupMMSMessageRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateGroupMMSMessageRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateGroupMMSMessageRequest(val *CreateGroupMMSMessageRequest) *NullableCreateGroupMMSMessageRequest {
	return &NullableCreateGroupMMSMessageRequest{value: val, isSet: true}
}

func (v NullableCreateGroupMMSMessageRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateGroupMMSMessageRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
