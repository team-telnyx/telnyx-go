...
type LogMessage struct {
	...
	Meta *LogMessageMeta `json:"meta,omitempty"`
}

type _LogMessage LogMessage
...
// SetSource gets a reference to the given LogMessageSource and assigns it to the Source field.
...
// SetMeta gets a reference to the given LogMessageMeta and assigns it to the Meta field.
...
func (o *LogMessage) UnmarshalJSON(data []byte) (err error) {
	...
	varLogMessage := _LogMessage{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLogMessage)

	if err != nil {
		return err
	}

	*o = LogMessage(varLogMessage)
