...
// checks if the FaxSendingStartedPayload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FaxSendingStartedPayload{}

// FaxSendingStartedPayload struct for FaxSendingStartedPayload
...
func (o FaxSendingStartedPayload) MarshalJSON() ([]byte, error) {
...
func (o FaxSendingStartedPayload) ToMap() (map[string]interface{}, error) {
...
type NullableFaxSendingStartedPayload struct {
	value *FaxSendingStartedPayload
	isSet bool
}

func (v NullableFaxSendingStartedPayload) Get() *FaxSendingStartedPayload {
	return v.value
}

func (v *NullableFaxSendingStartedPayload) Set(val *FaxSendingStartedPayload) {
	v.value = val
	v.isSet = true
}

func (v NullableFaxSendingStartedPayload) IsSet() bool {
	return v.isSet
}

func (v *NullableFaxSendingStartedPayload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFaxSendingStartedPayload(val *FaxSendingStartedPayload) *NullableFaxSendingStartedPayload {
	return &NullableFaxSendingStartedPayload{value: val, isSet: true}
}

func (v NullableFaxSendingStartedPayload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFaxSendingStartedPayload) UnmarshalJSON(src []byte) error {
	v.isSet = true
