...
// checks if the CallPlaybackStarted type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CallPlaybackStarted{}

// CallPlaybackStarted struct for CallPlaybackStarted
...
func (o *CallPlaybackStarted) GetPayload() CallPlaybackStartedPayload {
	if o == nil || IsNil(o.Payload) {
		var ret CallPlaybackStartedPayload
		return ret
	}
	return *o.Payload
}
...
// SetPayload gets a reference to the given CallPlaybackStartedPayload and assigns it to the Payload field.
func (o *CallPlaybackStarted) SetPayload(v CallPlaybackStartedPayload) {
	o.Payload = &v
}

func (o CallPlaybackStarted) MarshalJSON() ([]byte, error) {
...
func (o CallPlaybackStarted) ToMap() (map[string]interface{}, error) {
...
type NullableCallPlaybackStarted struct {
	value *CallPlaybackStarted
	isSet bool
}

func (v NullableCallPlaybackStarted) Get() *CallPlaybackStarted {
	return v.value
}

func (v *NullableCallPlaybackStarted) Set(val *CallPlaybackStarted) {
	v.value = val
	v.isSet = true
}

func (v NullableCallPlaybackStarted) IsSet() bool {
	return v.isSet
}

func (v *NullableCallPlaybackStarted) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCallPlaybackStarted(val *CallPlaybackStarted) *NullableCallPlaybackStarted {
	return &NullableCallPlaybackStarted{value: val, isSet: true}
}

func (v NullableCallPlaybackStarted) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCallPlaybackStarted) UnmarshalJSON(src []byte) error {
	v.isSet = true
