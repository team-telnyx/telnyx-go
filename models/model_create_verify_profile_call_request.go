...
// checks if the CreateVerifyProfileCallRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateVerifyProfileCallRequest{}

// CreateVerifyProfileCallRequest struct for CreateVerifyProfileCallRequest
...
func NewCreateVerifyProfileCallRequest() *CreateVerifyProfileCallRequest {
	this := CreateVerifyProfileCallRequest{}
...
func (o CreateVerifyProfileCallRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateVerifyProfileCallRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateVerifyProfileCallRequest struct {
	value *CreateVerifyProfileCallRequest
	isSet bool
}

func (v NullableCreateVerifyProfileCallRequest) Get() *CreateVerifyProfileCallRequest {
	return v.value
}

func (v *NullableCreateVerifyProfileCallRequest) Set(val *CreateVerifyProfileCallRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateVerifyProfileCallRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateVerifyProfileCallRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateVerifyProfileCallRequest(val *CreateVerifyProfileCallRequest) *NullableCreateVerifyProfileCallRequest {
	return &NullableCreateVerifyProfileCallRequest{value: val, isSet: true}
}

func (v NullableCreateVerifyProfileCallRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateVerifyProfileCallRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
