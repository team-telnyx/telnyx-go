...
// checks if the CallForkStopped type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CallForkStopped{}

// CallForkStopped struct for CallForkStopped
...
func (o CallForkStopped) MarshalJSON() ([]byte, error) {
...
func (o CallForkStopped) ToMap() (map[string]interface{}, error) {
...
type NullableCallForkStopped struct {
	value *CallForkStopped
	isSet bool
}

func (v NullableCallForkStopped) Get() *CallForkStopped {
	return v.value
}

func (v *NullableCallForkStopped) Set(val *CallForkStopped) {
	v.value = val
	v.isSet = true
}

func (v NullableCallForkStopped) IsSet() bool {
	return v.isSet
}

func (v *NullableCallForkStopped) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCallForkStopped(val *CallForkStopped) *NullableCallForkStopped {
	return &NullableCallForkStopped{value: val, isSet: true}
}

func (v NullableCallForkStopped) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCallForkStopped) UnmarshalJSON(src []byte) error {
	v.isSet = true
