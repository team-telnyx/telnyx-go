...
// checks if the RCSToItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RCSToItem{}

// RCSToItem struct for RCSToItem
...
func (o RCSToItem) MarshalJSON() ([]byte, error) {
...
func (o RCSToItem) ToMap() (map[string]interface{}, error) {
...
type NullableRCSToItem struct {
	value *RCSToItem
	isSet bool
}

func (v NullableRCSToItem) Get() *RCSToItem {
	return v.value
}

func (v *NullableRCSToItem) Set(val *RCSToItem) {
	v.value = val
	v.isSet = true
}

func (v NullableRCSToItem) IsSet() bool {
	return v.isSet
}

func (v *NullableRCSToItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRCSToItem(val *RCSToItem) *NullableRCSToItem {
	return &NullableRCSToItem{value: val, isSet: true}
}

func (v NullableRCSToItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRCSToItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
