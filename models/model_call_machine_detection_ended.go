...
// checks if the CallMachineDetectionEnded type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CallMachineDetectionEnded{}

// CallMachineDetectionEnded struct for CallMachineDetectionEnded
...
func NewCallMachineDetectionEnded() *CallMachineDetectionEnded {
	this := CallMachineDetectionEnded{}
	return &this
}
...
func (o *CallMachineDetectionEnded) GetPayload() CallMachineDetectionEndedPayload {
	if o == nil || IsNil(o.Payload) {
		var ret CallMachineDetectionEndedPayload
		return ret
	}
	return *o.Payload
}
...
// SetPayload gets a reference to the given CallMachineDetectionEndedPayload and assigns it to the Payload field.
func (o *CallMachineDetectionEnded) SetPayload(v CallMachineDetectionEndedPayload) {
	o.Payload = &v
}

func (o CallMachineDetectionEnded) MarshalJSON() ([]byte, error) {
...
func (o CallMachineDetectionEnded) ToMap() (map[string]interface{}, error) {
...
type NullableCallMachineDetectionEnded struct {
	value *CallMachineDetectionEnded
	isSet bool
}

func (v NullableCallMachineDetectionEnded) Get() *CallMachineDetectionEnded {
	return v.value
}

func (v *NullableCallMachineDetectionEnded) Set(val *CallMachineDetectionEnded) {
	v.value = val
	v.isSet = true
}

func (v NullableCallMachineDetectionEnded) IsSet() bool {
	return v.isSet
}

func (v *NullableCallMachineDetectionEnded) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCallMachineDetectionEnded(val *CallMachineDetectionEnded) *NullableCallMachineDetectionEnded {
	return &NullableCallMachineDetectionEnded{value: val, isSet: true}
}

func (v NullableCallMachineDetectionEnded) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCallMachineDetectionEnded) UnmarshalJSON(src []byte) error {
	v.isSet = true
