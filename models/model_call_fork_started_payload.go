...
// checks if the CallForkStartedPayload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CallForkStartedPayload{}

// CallForkStartedPayload struct for CallForkStartedPayload
...
func (o CallForkStartedPayload) MarshalJSON() ([]byte, error) {
...
func (o CallForkStartedPayload) ToMap() (map[string]interface{}, error) {
...
type NullableCallForkStartedPayload struct {
	value *CallForkStartedPayload
	isSet bool
}

func (v NullableCallForkStartedPayload) Get() *CallForkStartedPayload {
	return v.value
}

func (v *NullableCallForkStartedPayload) Set(val *CallForkStartedPayload) {
	v.value = val
	v.isSet = true
}

func (v NullableCallForkStartedPayload) IsSet() bool {
	return v.isSet
}

func (v *NullableCallForkStartedPayload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCallForkStartedPayload(val *CallForkStartedPayload) *NullableCallForkStartedPayload {
	return &NullableCallForkStartedPayload{value: val, isSet: true}
}

func (v NullableCallForkStartedPayload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCallForkStartedPayload) UnmarshalJSON(src []byte) error {
	v.isSet = true
