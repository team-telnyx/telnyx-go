...
// checks if the CallMachineGreetingEnded type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CallMachineGreetingEnded{}

// CallMachineGreetingEnded struct for CallMachineGreetingEnded
...
func (o *CallMachineGreetingEnded) GetPayload() CallMachineGreetingEndedPayload {
	if o == nil || IsNil(o.Payload) {
		var ret CallMachineGreetingEndedPayload
		return ret
	}
	return *o.Payload
}
...
// SetPayload gets a reference to the given CallMachineGreetingEndedPayload and assigns it to the Payload field.
func (o *CallMachineGreetingEnded) SetPayload(v CallMachineGreetingEndedPayload) {
	o.Payload = &v
}

func (o CallMachineGreetingEnded) MarshalJSON() ([]byte, error) {
...
func (o CallMachineGreetingEnded) ToMap() (map[string]interface{}, error) {
...
type NullableCallMachineGreetingEnded struct {
	value *CallMachineGreetingEnded
	isSet bool
}

func (v NullableCallMachineGreetingEnded) Get() *CallMachineGreetingEnded {
	return v.value
}

func (v *NullableCallMachineGreetingEnded) Set(val *CallMachineGreetingEnded) {
	v.value = val
	v.isSet = true
}

func (v NullableCallMachineGreetingEnded) IsSet() bool {
	return v.isSet
}

func (v *NullableCallMachineGreetingEnded) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCallMachineGreetingEnded(val *CallMachineGreetingEnded) *NullableCallMachineGreetingEnded {
	return &NullableCallMachineGreetingEnded{value: val, isSet: true}
}

func (v NullableCallMachineGreetingEnded) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCallMachineGreetingEnded) UnmarshalJSON(src []byte) error {
	v.isSet = true
