...
// checks if the CallAIGatherPartialResults type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CallAIGatherPartialResults{}

// CallAIGatherPartialResults struct for CallAIGatherPartialResults
type CallAIGatherPartialResults struct {
	...
	Payload *CallAIGatherPartialResultsPayload `json:"payload,omitempty"`
}
...
func NewCallAIGatherPartialResults() *CallAIGatherPartialResults {
	this := CallAIGatherPartialResults{}
	return &this
}
...
func (o *CallAIGatherPartialResults) GetPayload() CallAIGatherPartialResultsPayload {
	if o == nil || IsNil(o.Payload) {
		var ret CallAIGatherPartialResultsPayload
		return ret
	}
	return *o.Payload
}
...
// SetPayload gets a reference to the given CallAIGatherPartialResultsPayload and assigns it to the Payload field.
func (o *CallAIGatherPartialResults) SetPayload(v CallAIGatherPartialResultsPayload) {
	o.Payload = &v
}

func (o CallAIGatherPartialResults) MarshalJSON() ([]byte, error) {
...
func (o CallAIGatherPartialResults) ToMap() (map[string]interface{}, error) {
...
type NullableCallAIGatherPartialResults struct {
	value *CallAIGatherPartialResults
	isSet bool
}

func (v NullableCallAIGatherPartialResults) Get() *CallAIGatherPartialResults {
	return v.value
}

func (v *NullableCallAIGatherPartialResults) Set(val *CallAIGatherPartialResults) {
	v.value = val
	v.isSet = true
}

func (v NullableCallAIGatherPartialResults) IsSet() bool {
	return v.isSet
}

func (v *NullableCallAIGatherPartialResults) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCallAIGatherPartialResults(val *CallAIGatherPartialResults) *NullableCallAIGatherPartialResults {
	return &NullableCallAIGatherPartialResults{value: val, isSet: true}
}

func (v NullableCallAIGatherPartialResults) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCallAIGatherPartialResults) UnmarshalJSON(src []byte) error {
	v.isSet = true
