...
// checks if the ScheduledSmsEventResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScheduledSmsEventResponse{}

// ScheduledSmsEventResponse struct for ScheduledSmsEventResponse
...
type _ScheduledSmsEventResponse ScheduledSmsEventResponse
...
func NewScheduledSmsEventResponse(telnyxConversationChannel ConversationChannelType, telnyxEndUserTarget string, telnyxAgentTarget string, scheduledAtFixedDatetime time.Time, assistantId string, text string) *ScheduledSmsEventResponse {
	this := ScheduledSmsEventResponse{}
...
func (o ScheduledSmsEventResponse) MarshalJSON() ([]byte, error) {
...
func (o ScheduledSmsEventResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ScheduledSmsEventResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varScheduledSmsEventResponse := _ScheduledSmsEventResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varScheduledSmsEventResponse)

	if err != nil {
		return err
	}

	*o = ScheduledSmsEventResponse(varScheduledSmsEventResponse)

	return err
}

type NullableScheduledSmsEventResponse struct {
	value *ScheduledSmsEventResponse
	isSet bool
}

func (v NullableScheduledSmsEventResponse) Get() *ScheduledSmsEventResponse {
	return v.value
}

func (v *NullableScheduledSmsEventResponse) Set(val *ScheduledSmsEventResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableScheduledSmsEventResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableScheduledSmsEventResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScheduledSmsEventResponse(val *ScheduledSmsEventResponse) *NullableScheduledSmsEventResponse {
	return &NullableScheduledSmsEventResponse{value: val, isSet: true}
}

func (v NullableScheduledSmsEventResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScheduledSmsEventResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
