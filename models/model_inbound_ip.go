...
// checks if the InboundIp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InboundIp{}

// InboundIp struct for InboundIp
...
// GetDefaultPrimaryIpId returns the DefaultPrimaryIpId field value if set, zero value otherwise.
func (o *InboundIp) GetDefaultPrimaryIpId() string {
	if o == nil || IsNil(o.DefaultPrimaryIpId) {
		var ret string
		return ret
	}
	return *o.DefaultPrimaryIpId
}

// GetDefaultPrimaryIpIdOk returns a tuple with the DefaultPrimaryIpId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InboundIp) GetDefaultPrimaryIpIdOk() (*string, bool) {
	if o == nil || IsNil(o.DefaultPrimaryIpId) {
		return nil, false
	}
	return o.DefaultPrimaryIpId, true
}
...
// SetDefaultPrimaryIpId gets a reference to the given string and assigns it to the DefaultPrimaryIpId field.
func (o *InboundIp) SetDefaultPrimaryIpId(v string) {
	o.DefaultPrimaryIpId = &v
}

// GetDefaultSecondaryIpId returns the DefaultSecondaryIpId field value if set, zero value otherwise.
func (o *InboundIp) GetDefaultSecondaryIpId() string {
	if o == nil || IsNil(o.DefaultSecondaryIpId) {
		var ret string
		return ret
	}
	return *o.DefaultSecondaryIpId
}

// GetDefaultSecondaryIpIdOk returns a tuple with the DefaultSecondaryIpId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InboundIp) GetDefaultSecondaryIpIdOk() (*string, bool) {
	if o == nil || IsNil(o.DefaultSecondaryIpId) {
		return nil, false
	}
	return o.DefaultSecondaryIpId, true
}
...
// SetDefaultSecondaryIpId gets a reference to the given string and assigns it to the DefaultSecondaryIpId field.
func (o *InboundIp) SetDefaultSecondaryIpId(v string) {
	o.DefaultSecondaryIpId = &v
}

// GetDefaultTertiaryIpId returns the DefaultTertiaryIpId field value if set, zero value otherwise.
func (o *InboundIp) GetDefaultTertiaryIpId() string {
	if o == nil || IsNil(o.DefaultTertiaryIpId) {
		var ret string
		return ret
	}
	return *o.DefaultTertiaryIpId
}

// GetDefaultTertiaryIpIdOk returns a tuple with the DefaultTertiaryIpId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InboundIp) GetDefaultTertiaryIpIdOk() (*string, bool) {
	if o == nil || IsNil(o.DefaultTertiaryIpId) {
		return nil, false
	}
	return o.DefaultTertiaryIpId, true
}
...
// SetDefaultTertiaryIpId gets a reference to the given string and assigns it to the DefaultTertiaryIpId field.
func (o *InboundIp) SetDefaultTertiaryIpId(v string) {
	o.DefaultTertiaryIpId = &v
}
...
func (o InboundIp) MarshalJSON() ([]byte, error) {
...
func (o InboundIp) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DefaultPrimaryIpId) {
		toSerialize["default_primary_ip_id"] = o.DefaultPrimaryIpId
	}
	if !IsNil(o.DefaultSecondaryIpId) {
		toSerialize["default_secondary_ip_id"] = o.DefaultSecondaryIpId
	}
	if !IsNil(o.DefaultTertiaryIpId) {
		toSerialize["default_tertiary_ip_id"] = o.DefaultTertiaryIpId
	}
...
type NullableInboundIp struct {
	value *InboundIp
	isSet bool
}

func (v NullableInboundIp) Get() *InboundIp {
	return v.value
}

func (v *NullableInboundIp) Set(val *InboundIp) {
	v.value = val
	v.isSet = true
}

func (v NullableInboundIp) IsSet() bool {
	return v.isSet
}

func (v *NullableInboundIp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInboundIp(val *InboundIp) *NullableInboundIp {
	return &NullableInboundIp{value: val, isSet: true}
}

func (v NullableInboundIp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInboundIp) UnmarshalJSON(src []byte) error {
	v.isSet = true
