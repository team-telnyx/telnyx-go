...
// checks if the CallMachinePremiumDetectionEndedPayload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CallMachinePremiumDetectionEndedPayload{}

// CallMachinePremiumDetectionEndedPayload struct for CallMachinePremiumDetectionEndedPayload
...
func NewCallMachinePremiumDetectionEndedPayload() *CallMachinePremiumDetectionEndedPayload {
	this := CallMachinePremiumDetectionEndedPayload{}
	return &this
}
...
func (o CallMachinePremiumDetectionEndedPayload) MarshalJSON() ([]byte, error) {
...
func (o CallMachinePremiumDetectionEndedPayload) ToMap() (map[string]interface{}, error) {
...
type NullableCallMachinePremiumDetectionEndedPayload struct {
	value *CallMachinePremiumDetectionEndedPayload
	isSet bool
}

func (v NullableCallMachinePremiumDetectionEndedPayload) Get() *CallMachinePremiumDetectionEndedPayload {
	return v.value
}

func (v *NullableCallMachinePremiumDetectionEndedPayload) Set(val *CallMachinePremiumDetectionEndedPayload) {
	v.value = val
	v.isSet = true
}

func (v NullableCallMachinePremiumDetectionEndedPayload) IsSet() bool {
	return v.isSet
}

func (v *NullableCallMachinePremiumDetectionEndedPayload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCallMachinePremiumDetectionEndedPayload(val *CallMachinePremiumDetectionEndedPayload) *NullableCallMachinePremiumDetectionEndedPayload {
	return &NullableCallMachinePremiumDetectionEndedPayload{value: val, isSet: true}
}

func (v NullableCallMachinePremiumDetectionEndedPayload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCallMachinePremiumDetectionEndedPayload) UnmarshalJSON(src []byte) error {
	v.isSet = true
