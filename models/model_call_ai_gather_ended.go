...
// checks if the CallAIGatherEnded type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CallAIGatherEnded{}

// CallAIGatherEnded struct for CallAIGatherEnded
type CallAIGatherEnded struct {
	...
	Payload *CallAIGatherEndedPayload `json:"payload,omitempty"`
}
...
func (o *CallAIGatherEnded) GetPayload() CallAIGatherEndedPayload {
	if o == nil || IsNil(o.Payload) {
		var ret CallAIGatherEndedPayload
		return ret
	}
	return *o.Payload
}
...
// SetPayload gets a reference to the given CallAIGatherEndedPayload and assigns it to the Payload field.
func (o *CallAIGatherEnded) SetPayload(v CallAIGatherEndedPayload) {
	o.Payload = &v
}

func (o CallAIGatherEnded) MarshalJSON() ([]byte, error) {
...
func (o CallAIGatherEnded) ToMap() (map[string]interface{}, error) {
...
type NullableCallAIGatherEnded struct {
	value *CallAIGatherEnded
	isSet bool
}

func (v NullableCallAIGatherEnded) Get() *CallAIGatherEnded {
	return v.value
}

func (v *NullableCallAIGatherEnded) Set(val *CallAIGatherEnded) {
	v.value = val
	v.isSet = true
}

func (v NullableCallAIGatherEnded) IsSet() bool {
	return v.isSet
}

func (v *NullableCallAIGatherEnded) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCallAIGatherEnded(val *CallAIGatherEnded) *NullableCallAIGatherEnded {
	return &NullableCallAIGatherEnded{value: val, isSet: true}
}

func (v NullableCallAIGatherEnded) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCallAIGatherEnded) UnmarshalJSON(src []byte) error {
	v.isSet = true
