...
// checks if the VerifyProfileSMSResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VerifyProfileSMSResponse{}

// VerifyProfileSMSResponse struct for VerifyProfileSMSResponse
...
func (o *VerifyProfileSMSResponse) SetAlphaSenderNil() {
...
func (o VerifyProfileSMSResponse) MarshalJSON() ([]byte, error) {
...
func (o VerifyProfileSMSResponse) ToMap() (map[string]interface{}, error) {
...
type NullableVerifyProfileSMSResponse struct {
	value *VerifyProfileSMSResponse
	isSet bool
}

func (v NullableVerifyProfileSMSResponse) Get() *VerifyProfileSMSResponse {
	return v.value
}

func (v *NullableVerifyProfileSMSResponse) Set(val *VerifyProfileSMSResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVerifyProfileSMSResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVerifyProfileSMSResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVerifyProfileSMSResponse(val *VerifyProfileSMSResponse) *NullableVerifyProfileSMSResponse {
	return &NullableVerifyProfileSMSResponse{value: val, isSet: true}
}

func (v NullableVerifyProfileSMSResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVerifyProfileSMSResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
