...
// checks if the FaxMediaProcessedPayload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FaxMediaProcessedPayload{}

// FaxMediaProcessedPayload struct for FaxMediaProcessedPayload
...
func (o FaxMediaProcessedPayload) MarshalJSON() ([]byte, error) {
...
func (o FaxMediaProcessedPayload) ToMap() (map[string]interface{}, error) {
...
type NullableFaxMediaProcessedPayload struct {
	value *FaxMediaProcessedPayload
	isSet bool
}

func (v NullableFaxMediaProcessedPayload) Get() *FaxMediaProcessedPayload {
	return v.value
}

func (v *NullableFaxMediaProcessedPayload) Set(val *FaxMediaProcessedPayload) {
	v.value = val
	v.isSet = true
}

func (v NullableFaxMediaProcessedPayload) IsSet() bool {
	return v.isSet
}

func (v *NullableFaxMediaProcessedPayload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFaxMediaProcessedPayload(val *FaxMediaProcessedPayload) *NullableFaxMediaProcessedPayload {
	return &NullableFaxMediaProcessedPayload{value: val, isSet: true}
}

func (v NullableFaxMediaProcessedPayload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFaxMediaProcessedPayload) UnmarshalJSON(src []byte) error {
	v.isSet = true
