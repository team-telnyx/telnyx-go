...
// checks if the CreateIpConnectionRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateIpConnectionRequest{}

// CreateIpConnectionRequest struct for CreateIpConnectionRequest
...
func NewCreateIpConnectionRequest() *CreateIpConnectionRequest {
	this := CreateIpConnectionRequest{}
...
func (o *CreateIpConnectionRequest) SetEncryptedMediaNil() {
...
func (o *CreateIpConnectionRequest) SetIosPushCredentialIdNil() {
...
func (o *CreateIpConnectionRequest) SetAndroidPushCredentialIdNil() {
...
func (o *CreateIpConnectionRequest) SetWebhookEventFailoverUrlNil() {
...
func (o *CreateIpConnectionRequest) SetWebhookTimeoutSecsNil() {
...
func (o *CreateIpConnectionRequest) GetInbound() CreateInboundIpRequest {
	if o == nil || IsNil(o.Inbound) {
		var ret CreateInboundIpRequest
		return ret
	}
	return *o.Inbound
}
...
// SetInbound gets a reference to the given CreateInboundIpRequest and assigns it to the Inbound field.
...
func (o CreateIpConnectionRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateIpConnectionRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateIpConnectionRequest struct {
	value *CreateIpConnectionRequest
	isSet bool
}

func (v NullableCreateIpConnectionRequest) Get() *CreateIpConnectionRequest {
	return v.value
}

func (v *NullableCreateIpConnectionRequest) Set(val *CreateIpConnectionRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateIpConnectionRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateIpConnectionRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateIpConnectionRequest(val *CreateIpConnectionRequest) *NullableCreateIpConnectionRequest {
	return &NullableCreateIpConnectionRequest{value: val, isSet: true}
}

func (v NullableCreateIpConnectionRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateIpConnectionRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
