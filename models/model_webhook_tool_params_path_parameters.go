...
// checks if the WebhookToolParamsPathParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebhookToolParamsPathParameters{}
...
type WebhookToolParamsPathParameters struct {
...
func NewWebhookToolParamsPathParameters() *WebhookToolParamsPathParameters {
	this := WebhookToolParamsPathParameters{}
	return &this
}
...
func (o WebhookToolParamsPathParameters) MarshalJSON() ([]byte, error) {
...
func (o WebhookToolParamsPathParameters) ToMap() (map[string]interface{}, error) {
...
type NullableWebhookToolParamsPathParameters struct {
	value *WebhookToolParamsPathParameters
	isSet bool
}

func (v NullableWebhookToolParamsPathParameters) Get() *WebhookToolParamsPathParameters {
	return v.value
}

func (v *NullableWebhookToolParamsPathParameters) Set(val *WebhookToolParamsPathParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhookToolParamsPathParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhookToolParamsPathParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhookToolParamsPathParameters(val *WebhookToolParamsPathParameters) *NullableWebhookToolParamsPathParameters {
	return &NullableWebhookToolParamsPathParameters{value: val, isSet: true}
}

func (v NullableWebhookToolParamsPathParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebhookToolParamsPathParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
