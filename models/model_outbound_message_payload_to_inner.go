...
// checks if the OutboundMessagePayloadToInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OutboundMessagePayloadToInner{}

// OutboundMessagePayloadToInner struct for OutboundMessagePayloadToInner
type OutboundMessagePayloadToInner struct {
...
func NewOutboundMessagePayloadToInner() *OutboundMessagePayloadToInner {
	this := OutboundMessagePayloadToInner{}
	return &this
}
...
func (o OutboundMessagePayloadToInner) MarshalJSON() ([]byte, error) {
...
func (o OutboundMessagePayloadToInner) ToMap() (map[string]interface{}, error) {
...
type NullableOutboundMessagePayloadToInner struct {
	value *OutboundMessagePayloadToInner
	isSet bool
}

func (v NullableOutboundMessagePayloadToInner) Get() *OutboundMessagePayloadToInner {
	return v.value
}

func (v *NullableOutboundMessagePayloadToInner) Set(val *OutboundMessagePayloadToInner) {
	v.value = val
	v.isSet = true
}

func (v NullableOutboundMessagePayloadToInner) IsSet() bool {
	return v.isSet
}

func (v *NullableOutboundMessagePayloadToInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOutboundMessagePayloadToInner(val *OutboundMessagePayloadToInner) *NullableOutboundMessagePayloadToInner {
	return &NullableOutboundMessagePayloadToInner{value: val, isSet: true}
}

func (v NullableOutboundMessagePayloadToInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOutboundMessagePayloadToInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
