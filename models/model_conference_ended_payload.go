...
// checks if the ConferenceEndedPayload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConferenceEndedPayload{}

// ConferenceEndedPayload struct for ConferenceEndedPayload
...
func (o ConferenceEndedPayload) MarshalJSON() ([]byte, error) {
...
func (o ConferenceEndedPayload) ToMap() (map[string]interface{}, error) {
...
type NullableConferenceEndedPayload struct {
	value *ConferenceEndedPayload
	isSet bool
}

func (v NullableConferenceEndedPayload) Get() *ConferenceEndedPayload {
	return v.value
}

func (v *NullableConferenceEndedPayload) Set(val *ConferenceEndedPayload) {
	v.value = val
	v.isSet = true
}

func (v NullableConferenceEndedPayload) IsSet() bool {
	return v.isSet
}

func (v *NullableConferenceEndedPayload) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConferenceEndedPayload(val *ConferenceEndedPayload) *NullableConferenceEndedPayload {
	return &NullableConferenceEndedPayload{value: val, isSet: true}
}

func (v NullableConferenceEndedPayload) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConferenceEndedPayload) UnmarshalJSON(src []byte) error {
	v.isSet = true
