...
// checks if the ConferenceSpeakStarted type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConferenceSpeakStarted{}

// ConferenceSpeakStarted struct for ConferenceSpeakStarted
...
func (o ConferenceSpeakStarted) MarshalJSON() ([]byte, error) {
...
func (o ConferenceSpeakStarted) ToMap() (map[string]interface{}, error) {
...
type NullableConferenceSpeakStarted struct {
	value *ConferenceSpeakStarted
	isSet bool
}

func (v NullableConferenceSpeakStarted) Get() *ConferenceSpeakStarted {
	return v.value
}

func (v *NullableConferenceSpeakStarted) Set(val *ConferenceSpeakStarted) {
	v.value = val
	v.isSet = true
}

func (v NullableConferenceSpeakStarted) IsSet() bool {
	return v.isSet
}

func (v *NullableConferenceSpeakStarted) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConferenceSpeakStarted(val *ConferenceSpeakStarted) *NullableConferenceSpeakStarted {
	return &NullableConferenceSpeakStarted{value: val, isSet: true}
}

func (v NullableConferenceSpeakStarted) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConferenceSpeakStarted) UnmarshalJSON(src []byte) error {
	v.isSet = true
