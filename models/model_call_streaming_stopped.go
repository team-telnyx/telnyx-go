...
// checks if the CallStreamingStopped type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CallStreamingStopped{}

// CallStreamingStopped struct for CallStreamingStopped
...
func (o CallStreamingStopped) MarshalJSON() ([]byte, error) {
...
func (o CallStreamingStopped) ToMap() (map[string]interface{}, error) {
...
type NullableCallStreamingStopped struct {
	value *CallStreamingStopped
	isSet bool
}

func (v NullableCallStreamingStopped) Get() *CallStreamingStopped {
	return v.value
}

func (v *NullableCallStreamingStopped) Set(val *CallStreamingStopped) {
	v.value = val
	v.isSet = true
}

func (v NullableCallStreamingStopped) IsSet() bool {
	return v.isSet
}

func (v *NullableCallStreamingStopped) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCallStreamingStopped(val *CallStreamingStopped) *NullableCallStreamingStopped {
	return &NullableCallStreamingStopped{value: val, isSet: true}
}

func (v NullableCallStreamingStopped) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCallStreamingStopped) UnmarshalJSON(src []byte) error {
	v.isSet = true
