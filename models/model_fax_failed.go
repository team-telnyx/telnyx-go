...
// checks if the FaxFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FaxFailed{}

// FaxFailed struct for FaxFailed
...
// SetPayload gets a reference to the given FaxFailedPayload and assigns it to the Payload field.
func (o *FaxFailed) SetPayload(v FaxFailedPayload) {
	o.Payload = &v
}

func (o FaxFailed) MarshalJSON() ([]byte, error) {
...
func (o FaxFailed) ToMap() (map[string]interface{}, error) {
...
type NullableFaxFailed struct {
	value *FaxFailed
	isSet bool
}

func (v NullableFaxFailed) Get() *FaxFailed {
	return v.value
}

func (v *NullableFaxFailed) Set(val *FaxFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableFaxFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableFaxFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFaxFailed(val *FaxFailed) *NullableFaxFailed {
	return &NullableFaxFailed{value: val, isSet: true}
}

func (v NullableFaxFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFaxFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
