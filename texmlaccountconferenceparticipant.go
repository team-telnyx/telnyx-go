...
type TexmlAccountConferenceParticipantParticipantsParams struct {
	...
	MachineDetectionBeepProfile TexmlAccountConferenceParticipantParticipantsParamsMachineDetectionBeepProfile `json:"MachineDetectionBeepProfile,omitzero"`
...
// beeps whose volume is too unsteady for the default profile. Only used when
// MachineDetection is enabled.
type TexmlAccountConferenceParticipantParticipantsParamsMachineDetectionBeepProfile string

const (
	TexmlAccountConferenceParticipantParticipantsParamsMachineDetectionBeepProfileBoth     TexmlAccountConferenceParticipantParticipantsParamsMachineDetectionBeepProfile = "both"
	TexmlAccountConferenceParticipantParticipantsParamsMachineDetectionBeepProfileFreqOnly TexmlAccountConferenceParticipantParticipantsParamsMachineDetectionBeepProfile = "freq_only"
)
