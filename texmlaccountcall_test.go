	...
	_, err := client.Texml.Accounts.Calls.Calls(
		...
		telnyx.TexmlAccountCallCallsParams{
			OfWithURL: &telnyx.TexmlAccountCallCallsParamsBodyWithURL{
				...
				MachineDetectionBeepMaxFrequency:         telnyx.Int(2000),
				MachineDetectionBeepMinFrequency:         telnyx.Int(550),
				MachineDetectionBeepMinToneDuration:      telnyx.Int(300),
				MachineDetectionBeepProfile:              "freq_only",
				MachineDetectionBeepSpectralConfirmation: telnyx.Bool(true),
				MachineDetectionBeepSpectralMinPurity:    telnyx.Float(0.8),
				MachineDetectionBeepSpectralRejectFaxCng: telnyx.Bool(true),
				MachineDetectionBeepSpectralWindow:       telnyx.Int(100),
...
func TestTexmlAccountCallGetCallsWithOptionalParams(t *testing.T) {
	...
	_, err := client.Texml.Accounts.Calls.GetCalls(
		...
		telnyx.TexmlAccountCallGetCallsParams{
			...
			EndTimeLt:   telnyx.String("EndTime<"),
			EndTimeGt:   telnyx.String("EndTime>"),
			From:        telnyx.String("From"),
			Page:        telnyx.Int(0),
			PageSize:    telnyx.Int(0),
			PageToken:   telnyx.String("PageToken"),
			StartTime:   telnyx.String("StartTime"),
			StartTimeLt: telnyx.String("StartTime<"),
			StartTimeGt: telnyx.String("StartTime>"),
