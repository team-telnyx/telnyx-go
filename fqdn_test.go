...
func TestFqdnNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Fqdns.New(context.TODO(), telnyx.FqdnNewParams{
		ConnectionID:  "1516447646313612565",
		DNSRecordType: "a",
		Fqdn:          "example.com",
		Port:          telnyx.Int(8080),
	})
	if err != nil {
...
func TestFqdnListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Fqdns.List(context.TODO(), telnyx.FqdnListParams{
		Filter: telnyx.FqdnListParamsFilter{
