...
type VirtualCrossConnectCreateParam struct {
	...
	BgpAsn param.Opt[float64] `json:"bgp_asn,omitzero"`
	// The Virtual Private Cloud with which you would like to establish a cross
	// connect.
	CloudProvider string `json:"cloud_provider,omitzero"`
	...
	// endpoint.
	CloudProviderRegion param.Opt[string] `json:"cloud_provider_region,omitzero"`
	// The authentication key for BGP peer configuration.
	...
	PrimaryCloudAccountID param.Opt[string] `json:"primary_cloud_account_id,omitzero"`
...
func (r VirtualCrossConnectCreateParam) MarshalJSON() (data []byte, err error) {
	type shadow struct {
		*VirtualCrossConnectCreateParam
		MarshalJSON bool `json:"-"` // Prevent inheriting [json.Marshaler] from the embedded field
	}
	return param.MarshalObject(r, shadow{&r, false})
}

type VirtualCrossConnectPatchParam struct {
	// The IP address assigned for your side of the Virtual Cross
	// Connect.<br /><br />If none is provided, one will be generated for
...
func (r VirtualCrossConnectPatchParam) MarshalJSON() (data []byte, err error) {
	type shadow VirtualCrossConnectPatchParam
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *VirtualCrossConnectPatchParam) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type VirtualCrossConnectNewParams struct {
	VirtualCrossConnectCreate VirtualCrossConnectCreateParam
	paramObj
}

func (r VirtualCrossConnectNewParams) MarshalJSON() (data []byte, err error) {
	return shimjson.Marshal(r.VirtualCrossConnectCreate)
}
...
type VirtualCrossConnectUpdateParams struct {
	VirtualCrossConnectPatch VirtualCrossConnectPatchParam
	paramObj
}

func (r VirtualCrossConnectUpdateParams) MarshalJSON() (data []byte, err error) {
	return shimjson.Marshal(r.VirtualCrossConnectPatch)
}
