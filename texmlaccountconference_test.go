...
func TestTexmlAccountConferenceGet(t *testing.T) {
...
func TestTexmlAccountConferenceUpdateWithOptionalParams(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Texml.Accounts.Conferences.Update(
		...
		telnyx.TexmlAccountConferenceUpdateParams{
			AccountSid:     "account_sid",
			AnnounceMethod: telnyx.TexmlAccountConferenceUpdateParamsAnnounceMethodGet,
...
func TestTexmlAccountConferenceGetConferencesWithOptionalParams(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Texml.Accounts.Conferences.GetConferences(
		...
		telnyx.TexmlAccountConferenceGetConferencesParams{
			...
			FriendlyName: telnyx.String("FriendlyName"),
			Page:         telnyx.Int(0),
			PageSize:     telnyx.Int(0),
			PageToken:    telnyx.String("PageToken"),
			Status:       telnyx.TexmlAccountConferenceGetConferencesParamsStatusInit,
		},
	)
	if err != nil {
		var apierr *telnyx.Error
...
func TestTexmlAccountConferenceGetRecordings(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestTexmlAccountConferenceGetRecordingsJson(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
